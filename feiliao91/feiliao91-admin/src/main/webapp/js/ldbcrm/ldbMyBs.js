Ext.namespace("ast.ast1949.phoneMyBs");

ast.ast1949.phoneMyBs.INFOFIELD=[
...
ast.ast1949.phoneMyBs.PHONEINFOFIELD=[
	{name:"id",mapping:"id"},
...
ast.ast1949.phoneMyBs.Grid = Ext.extend(Ext.grid.GridPanel,{
	constructor:function(config){
		...
		var storeUrl = Context.ROOT + Context.PATH + "/phone/queryAllPhoneMyBs.htm";
		
		var _store= new Ext.data.JsonStore({
			root:"records",
			totalProperty: 'totalRecords',
			remoteSort:true,
			fields:ast.ast1949.phoneMyBs.INFOFIELD,
			url: storeUrl,
			autoLoad:true
		});
		var tbar = [
...
//			iconCls:"add",
//			handler:function(){
//				ast.ast1949.phoneMyBs.updatePhoneInfo(0);
//			}
//		}
		{
			text:"写小计",
			iconCls:"add",
			handler:function(){
//				ast.ast1949.phoneMyBs.addCRMLog(row.get("id"));
		...
		,"-",{
			...
			handler:function(){
				var row=grid.getSelectionModel().getSelected();
				ast.ast1949.phoneMyBs.updatePhoneInfo(row.get("id"))
			}
		},"-",{
			text:"询盘群发",
			iconCls:"copy",
		...
		ast.ast1949.phoneMyBs.Grid.superclass.constructor.call(this,c);
	},
	loadDefault:null,
	contextmenu:null,
 ...
 * 重新分配客户信息
 * */
ast.ast1949.phoneMyBs.reassign=function(grid, oldassignArr, cs, csname){
...
//账户信息修改
ast.ast1949.phoneMyBs.updatePhoneInfo=function(id,companyId){
	var form=new ast.ast1949.phoneMyBs.UpdatePhoneInfoForm({
	});
...
ast.ast1949.phoneMyBs.UpdatePhoneInfoForm = Ext.extend(Ext.form.FormPanel,{
	targetGrid:null,
	constructor:function(config){
		config = config||{};
		Ext.apply(this,config);
		...
		ast.ast1949.phoneMyBs.UpdatePhoneInfoForm.superclass.constructor.call(this,c);
	},
	loadInit:function(id,companyId){
		...
		form.store = new Ext.data.JsonStore({
			fields : ast.ast1949.phoneMyBs.PHONEINFOFIELD,
...
ast.ast1949.phoneMyBs.SearchForm = Ext.extend(Ext.form.FormPanel,{
	targetGrid:null,
	constructor:function(config){
		config = config||{};
		Ext.apply(this,config);
		...
		ast.ast1949.phoneMyBs.SearchForm.superclass.constructor.call(this,c);
