...
ast.ast1949.admin.categoryCompanyPrice.editPanel = function(_cfg){
	if(_cfg == null){
		_cfg = {};
	}
	...
	var isView = true;
	var notView = false;
	var panel = new ast.ast1949.admin.categoryCompanyPrice.InfoFormPanel({
		title:title,
		view:isView,
		nView:notView,
...
//	panel.initFocus();
	...
	var _store = new Ext.data.JsonStore({
		...
		url : Context.ROOT + Context.PATH + "/admin/categorycompanyprice/init.htm",
		autoLoad:true,
		listeners:{
...
//					win.close();
	...
	function onSaveSuccess(){
		...
		var _tree=Ext.getCmp("adsplaces-tree");
		if(_tree!=null){
