Ext.namespace("ast.ast1949.admin.bbs.postCategory");

ast.ast1949.admin.bbs.postCategory.treePanel = function(_cfg){
...
//	var _title = _cfg["title"] || "";
	...
	var data = new Ext.tree.TreeLoader({url: Context.ROOT+Context.PATH+"/admin/bbs/posts/getPostCategoryChild.htm"});
