...
ast.ast1949.admin.bbs.category.InfoFormPanel = Ext.extend(Ext.Panel,{
	_form:null,
	constructor:function(_cfg){
		...
		var _url=Context.ROOT+Context.PATH+"/bbs/bbscategory/categoryTreeNode.htm" ||Ext.get("parentId").dom.value;
		...
		var tree;
      	parentCombo.on("expand",function(){
      		if(tree==null){
	      		tree =  ast.ast1949.admin.bbs.category.treePanel({el:"category-combo",rootData:""});
		...
		ast.ast1949.admin.bbs.category.InfoFormPanel.superclass.constructor.call(this,{
			title:_title,
			closeable:true,
			width:700,
			autoHeight:true,
