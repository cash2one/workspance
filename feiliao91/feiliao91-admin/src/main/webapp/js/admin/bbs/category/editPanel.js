...
ast.ast1949.admin.bbs.category.editPanel = function(_cfg){
	if(_cfg == null){
		_cfg = {};
	}
	...
	var isView = true;
	var notView = false;
	var panel = new ast.ast1949.admin.bbs.category.InfoFormPanel({
		title:title,
		view:isView,
		nView:notView,
	...
	var _store = new Ext.data.JsonStore({
		...
		url : Context.ROOT + Context.PATH + "/bbs/bbscategory/querySimpleCategoryById.htm",
		autoLoad:true,
		listeners:{
