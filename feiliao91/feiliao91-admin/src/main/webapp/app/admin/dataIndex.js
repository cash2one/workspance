...
Ext.define("DataIndexFormModel",{
	...
	proxy:{
		type:"ajax",
		api:{
			read:Context.ROOT+"/admin/dataindex/initDataIndex.htm"
		}
	}
});
...
Ext.define("DataIndexCategoryModel",{
	...
	proxy:{
		type:"ajax",
		api:{
			read:Context.ROOT+"/admin/dataindex/initCategory.htm"
		}
	}
});
...
Ext.define("ast.ast1949.admin.dataIndex.MainGrid", {
	...
	initComponent:function(){
		...
		var _store=Ext.create("Ext.data.Store",{
			...
			proxy:{
				type:"ajax",
				url:Context.ROOT+"/admin/dataindex/queryDataIndex.htm",
	...
	deleteModel:function(selections){
		...
		Ext.Msg.confirm(Context.MSG_TITLE,"信息删除后将无法恢复，您确定要删除这些信息吗？",function(o){
			...
			Ext.Array.each(selections, function(obj, index, countriesItSelf){
				Ext.Ajax.request({
					url: Context.ROOT+"/admin/dataindex/deleteIndex.htm",
					params: {
						id: obj.getId()
					},
	...
	editModel:function(btn,e){
		...
		var form=Ext.create("ast.ast1949.admin.dataIndex.MainForm",{
			saveUrl:Context.ROOT+"/admin/dataindex/update.htm",
			region:"center"
		});
		...
		var c={
			items:[{
				...
				handler:function(btn,e){
					...
					var form=Ext.create("ast.ast1949.admin.dataIndex.CategoryForm",{
						saveUrl:Context.ROOT+"/admin/dataindex/updateCategory.htm",
						region:"center",
						treeNode:this.getTreeNode()
					});
				...
				handler:function(btn,e){
					...
					Ext.Msg.confirm(Context.MSG_TITLE,"类别删除后将无法恢复（包括子类别），您确定要删除这些类别吗？",function(o){
						...
						Ext.Ajax.request({
							url: Context.ROOT+"/admin/dataindex/deleteCategory.htm",
...
Ext.define("ast.ast1949.admin.dataIndex.CategoryForm",{
	...
	saveUrl:Context.ROOT+"/admin/dataindex/addCategory.htm",
...
Ext.define("ast.ast1949.admin.dataIndex.MainForm",{
				...
				listeners:{
					"focus":function(field,e){
						...
						var win=Ext.create("ast.ast1949.util.TreeSelectorWin",{
							...
							modal:true,
							initCode:initCode,
							queryUrl:Context.ROOT+"/admin/dataindex/categoryChild.htm",
				...
				listeners:{
					"focus":function(field,e){
						var win=Ext.create("ast.ast1949.util.UploadWin",{
							uploadUrl:Context.ROOT+"/common/doUpload.htm",
	...
	saveUrl:Context.ROOT+"/admin/dataindex/add.htm",
	config:{
		saveUrl:null
	}
});
