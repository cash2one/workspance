...
public class SynNewLDBTask implements ZZTask {
	...
	public boolean exec(Date baseDate) throws Exception {
		...
		String from = DateUtil.toString(
				DateUtil.getDateAfterDays(baseDate, -6), "yyyy-MM-dd");
		// 搜出时间段的所有记录
	...
	public List<Map<String, String>> getRecord(String from, String to) {
		String sql = "select id,billable,billableMinutes,called,caller,startDate,endDate,disPosition,amaNumber,answerDate from T_CDRBACKUP where startDate>='"
				+ from + "' and startDate<='" + to + "'";
		final List<Map<String, String>> list = new ArrayList<Map<String, String>>();
		DBUtils.select("ivr", sql, new IReadDataHandler() {
			@Override
			public void handleRead(ResultSet rs) throws SQLException {
				while (rs.next()) {
	...
	public static void main(String[] args) throws ParseException, Exception {
		...
		SynNewLDBTask obj = new SynNewLDBTask();
