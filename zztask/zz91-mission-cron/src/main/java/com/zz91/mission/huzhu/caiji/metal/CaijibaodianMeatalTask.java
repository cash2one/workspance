...
/**
 * 互助抓取 废旧物资网 对应bbs_post 中的类别:废料学院-行业知识-废金属 采集4个网页链接
 * 采集地址:http://baodian.feijiu.net/hybd-p-cid6.7.10-.html
 * http://baodian.feijiu.net/hybd-p-cid6.7.20-.html
 * http://baodian.feijiu.net/hybd-p-cid6.7.21-.html
 * http://baodian.feijiu.net/hybd-p-cid6.7.23-.html
 * 
 * @author root
 * 
 */
public class CaijibaodianMeatalTask implements ZZTask {
	...
	public void sendEmail(String url, Integer typeId, String defaultTime)
		...
		MailUtil.getInstance().sendMail("互助废料学院-废金属 废旧物资网-自动抓取报错",
	...
	public static void main(String[] args) {
		...
		CaijibaodianMeatalTask js = new CaijibaodianMeatalTask();
		try {
