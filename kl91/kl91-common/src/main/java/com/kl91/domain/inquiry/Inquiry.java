...
public class Inquiry extends DomainSupport{
	...
	*/
	...
	public Inquiry(Integer id, Integer fromCid, Integer toCid,
			Integer targetId, Integer targetType, String title, String content,
			String contentReply, Integer isFromTrash, Integer isToTrash,
			Integer isFromView, Integer isToView, Date gmtPost, Date gmtReply,
