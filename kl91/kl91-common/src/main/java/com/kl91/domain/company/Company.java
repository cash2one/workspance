...
public class Company extends DomainSupport {
	...
	public Company(Integer id, String account, String companyName,
			...
			String contact, String password, String mobile,Integer isActive, String qq,
			...
			Date showTime, Date gmtLastLogin, Date gmtCreated, Date gmtModified,Integer numPass) {
		super();
		this.id = id;
