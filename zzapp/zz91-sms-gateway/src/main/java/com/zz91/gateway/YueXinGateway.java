...
public class YueXinGateway implements ZZSms {

	final static String ACCOUNT = "hzasto";
...
//	final static CommonUtils commonUtils = new CommonUtils();
	...
	public Object balance() {
		...
		do {
			...
			String result = "";
//			try {
//				result = commonUtils.httpClientHtml(BALANCE_URL,HttpUtils.CHARSET_UTF8);
...
//			}
			try {
				result = HttpUtils.getInstance().httpGet(BALANCE_URL,HttpUtils.CHARSET_UTF8);
...
//				result = HttpUtils.getInstance().httpGet(SEND_URL+"?Account="+ACCOUNT+"&Password="+PASSWORD+"&Mobile="+mobile+"&Content="+URLEncoder.encode(content, HttpUtils.CHARSET_UTF8)+"&Exno=0", HttpUtils.CHARSET_UTF8);
	...
	public static void main(String[] args) {
		YueXinGateway gateway = new YueXinGateway();
