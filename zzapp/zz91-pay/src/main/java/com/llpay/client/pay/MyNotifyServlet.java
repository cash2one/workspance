...
*
*/
public class MyNotifyServlet extends HttpServlet{
...
//        System.out.println("进入支付异步通知数据接收处理");
        ...
        String reqStr = PayUtil.readReqStr(req);
        if (PayUtil.isnull(reqStr))
        {
...
//        System.out.println("接收支付异步通知数据：【" + reqStr + "】");
        try
        {
            if (!PayUtil.checkSign(reqStr, PartnerConfig.YT_PUB_KEY,
