           ...
           <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                 <input type="button" onclick="goNext('plainPay.jsp')" class="btn orange w100 mt10" value="普通接入" />
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                 <input type="button" onclick="goNext('prepositPay.jsp')" class="btn orange w100 mt10" value="卡前置接入" />
                </td>
            </tr>
        </table>
        </form>
        ...
        function goNext(url){
            var user_id = document.getElementById("user_id").value;
	         if(user_id==""){
	           ...
	           document.form1.action="<%=path %>"+url;
