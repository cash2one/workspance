...
<html>
    <head>
        ...
        <title>连连支付WEB安全支付收银台测试DEMO</title>
    ...
    <body>
        ...
        <span class="logo"><a href="javascript:void(0)">普通接入</a>
        </span>
        <span class="fr about"><a href="<%=path %>about.jsp">关于</a>
        </span>
        </header>
        <section class="info">
         <form action="<%=path %>myPay.htm" method="post">
        <table border="0" cellspacing="0" cellpadding="0" class="table_ui">
            <tr>
                <td colspan="2">
                    <span class="ft_gray">连连科技话费充值</span>
                </td>
            </tr>
            <tr>
                <td width="100">
                    <span class="ft_gray">面值：</span>
                </td>
            ...
            <tr>
                <td colspan="2">
                     <input type="submit" class="btn orange w100 mt10" value="提交去支付" />
                </td>
            </tr>
        </table>
            <input type="hidden" name="user_id" value="201411101000093502"/>
             <input type="hidden" name="paymod" value="plain"/>
             <input type="hidden" name="money_order" value="0.01"/>
            <input type="hidden" name="name_goods" value="再生通一年"/>
            </form>
        </section>
