...
com.zz91.ads.board.login.LoginForm = Ext.extend(Ext.form.FormPanel, {
	constructor : function(config) {
		...
		com.zz91.ads.board.login.LoginForm.superclass.constructor
				.call(this, c);
...
com.zz91.ads.board.login.UserLoginWin = function(doSuccess) {
	var form = new com.zz91.ads.board.login.LoginForm( {
		region : "center"
	});
