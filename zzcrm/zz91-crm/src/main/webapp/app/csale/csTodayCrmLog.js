Ext.namespace("com.zz91.ep.cscrmLog");

com.zz91.ep.cscrmLog.NOTEFIELD=[
	{name:"id",mapping:"id"},
...
com.zz91.ep.cscrmLog.phoneNoteGrid=Ext.extend(Ext.grid.GridPanel,{
	constructor:function(config){
		...
		var _store = new Ext.data.JsonStore({
			...
			fields: com.zz91.ep.cscrmLog.NOTEFIELD,
			url:Context.ROOT + "/csale/cscompany/queryCrmLogByToday.htm",
			autoLoad:true
		});
		...
		var _cm=new Ext.grid.ColumnModel( [_sm,{
			...
			renderer:function(value, metaData, record, rowIndex, colIndex, store){
				...
				var url = "<a href='"+Context.ROOT+"/csale/cscompany/contactDetails.htm?visbile=5&id="+cid+"' target='_blank'>"+returnValue+"</a>";
				return url ;
			}
		},{
			header : "联系时间",
		...
		com.zz91.ep.cscrmLog.phoneNoteGrid.superclass.constructor.call(this,c);
	},
