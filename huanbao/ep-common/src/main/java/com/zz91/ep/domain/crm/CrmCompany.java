...
public class CrmCompany implements java.io.Serializable {
    ...
    public String getMainProductBuy() {
    	if (mainProductBuy!=null && "".equals(mainProductBuy)) {
    		mainProductBuy = mainProductBuy.replace("'", " ");
		}
    ...
    public String getMainProductSupply() {
    	if (mainProductSupply!=null && "".equals(mainProductSupply)) {
    		mainProductSupply = mainProductSupply.replace("'", " ");
		}
