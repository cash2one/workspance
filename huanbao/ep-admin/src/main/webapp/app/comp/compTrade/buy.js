Ext.namespace("com.zz91.comp.buy");

var COMP=new function(){
	this.BUY_GRID="buygrid";
}

com.zz91.comp.buy.GRIDFIELD=[
...
com.zz91.comp.buy.grid=Ext.extend(Ext.grid.GridPanel,{
	constructor:function(config){
		...
		var _store=new Ext.data.JsonStore({
			...
			remoteSort:true,
			url:Context.ROOT+"/comp/comp/queryCompBuy.htm",
			fields:com.zz91.comp.buy.GRIDFIELD,
			autoLoad:true
		});
		...
		com.zz91.comp.buy.grid.superclass.constructor.call(this,c);
	}
});