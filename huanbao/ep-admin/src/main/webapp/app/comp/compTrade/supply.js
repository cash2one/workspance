Ext.namespace("com.zz91.comp.supply");

var COMP=new function(){
	this.SUPPLY_GRID="supplygrid";
}

com.zz91.comp.supply.GRIDFIELD=[
...
com.zz91.comp.supply.grid=Ext.extend(Ext.grid.GridPanel,{
	constructor:function(config){
		...
		var _store=new Ext.data.JsonStore({
			...
			remoteSort:true,
			url:Context.ROOT+"/comp/comp/queryCompSupply.htm",
			fields:com.zz91.comp.supply.GRIDFIELD,
			autoLoad:true
		});
		...
		com.zz91.comp.supply.grid.superclass.constructor.call(this,c);
	}
});