Ext.namespace("com.zz91.ep.admin.param");
...
com.zz91.ep.admin.param.listParamGrid = Ext.extend(Ext.grid.GridPanel,{
		...
		var c={
			...
			tbar: [{
				...
				handler :function(btn){
					...
					if(select.length > 0){
						com.zz91.ep.admin.param.addParamWin(select[0]);
					}
				}
			},{
				text: "编辑参数",
				...
				handler :function(btn){
					...
					var select=type.getSelectionModel().getSelections();
					if(select.length > 0){
						com.zz91.ep.admin.param.editParamWin(selectedRecord.get("id"),select[0]);
					}
//					com.zz91.ep.admin.param.editParamWin(0);
				}
			},{
				text: "删除参数",
				iconCls:"delete16",
...
//						params:{"id":row[0].get("id")},
		...
		com.zz91.ep.admin.param.listParamGrid.superclass.constructor.call(this,c);
	}
});

com.zz91.ep.admin.param.listParamTypeGrid = Ext.extend(Ext.grid.GridPanel,{
	...
	constructor:function(config){
		...
		var c={
			...
			tbar: [{
				...
				handler :function(btn){
					// TODO 添加参数配置
					com.zz91.ep.admin.param.addParamTypeWin();
				}
			},{
				text: "修改参数类型",
				iconCls : "edit16",
				handler :function(btn){
					...
					com.zz91.ep.admin.param.editParamTypeWin(selectedRecord.get("key"));
				}
			},{
				text: "删除参数类型(慎重)",
				iconCls:"delete16",
		...
		com.zz91.ep.admin.param.listParamTypeGrid.superclass.constructor.call(this,c);
	}
});

com.zz91.ep.admin.param.paramForm = Ext.extend(Ext.form.FormPanel,{
	constructor:function(config){
		config = config||{};
		Ext.apply(this,config);
		...
		com.zz91.ep.admin.param.paramForm.superclass.constructor.call(this,c);
...
com.zz91.ep.admin.param.addParamWin = function (typerecord){
	var form = new com.zz91.ep.admin.param.paramForm({
...
com.zz91.ep.admin.param.editParamWin = function(id,typerecord){
	var form = new com.zz91.ep.admin.param.paramForm({
//		id:Const.PRODUCT_INFO_FORM,
		region:"center",
...
com.zz91.ep.admin.param.paramTypeForm = Ext.extend(Ext.form.FormPanel,{
	constructor:function(config){
		config = config||{};
		Ext.apply(this,config);
		...
		com.zz91.ep.admin.param.paramTypeForm.superclass.constructor.call(this,c);
...
com.zz91.ep.admin.param.addParamTypeWin = function (){
	var form = new com.zz91.ep.admin.param.paramTypeForm({
		region:"center"
	});
	var win = new Ext.Window({
...
com.zz91.ep.admin.param.editParamTypeWin = function(key){
	var form = new com.zz91.ep.admin.param.paramTypeForm({
		region:"center",
