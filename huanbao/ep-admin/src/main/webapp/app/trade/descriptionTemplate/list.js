...
Ext.onReady(function() {
			...
			var storeUrl = Context.ROOT+"/trade/descriptiontemplate/query.htm";

			var title = "供求详细信息模板管理";

			var grid = new com.zz91.StandardGridPanel({
						sm : sm,
						cm : cm,
						reader : reader,
						storeUrl : storeUrl,
			...
			var view = new com.zz91.StandardGridPanelViewport({
						grid : grid
					});
			...
			function onAdd() {
				// var code="10260001";
				new com.zz91.trade.descriptionTemplate.AddFormWin({
							_grid : grid
						});
			}
			...
			function doDelete(_btn) {
				...
				conn.request({
							url : Context.ROOT+"/trade/descriptiontemplate/delete.htm?ids="
									+ _ids.join(','),
							method : "get",
							scope : this,
