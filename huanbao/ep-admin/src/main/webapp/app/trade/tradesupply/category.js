Ext.namespace("com.zz91.trade.supply.category");
...
com.zz91.trade.supply.category.TreePanel = Ext.extend(Ext.tree.TreePanel,{
	constructor:function(config){
		config = config||{};
		Ext.apply(this,config);
		
		var treeLoad = new Ext.tree.TreeLoader({
			url:Context.ROOT + "/trade/tradesupply/child.htm",
			listeners:{
		...
		com.zz91.trade.supply.category.TreePanel.superclass.constructor.call(this,c);
	},
	contextmenu:new Ext.menu.Menu({
		items:[{
			...
			handler:function(btn){
				...
				com.zz91.trade.supply.category.AddWin(code,text);
			}
		},{
			id: "cm-edit",
			cls:"edit16",
			...
			handler:function(btn){
				if(btn.parentMenu.contextNode.attributes.data>0){
					com.zz91.trade.supply.category.EditWin(
...
com.zz91.trade.supply.category.EditForm=Ext.extend(Ext.form.FormPanel,{
	...
	constructor:function(config){
		...
		com.zz91.trade.supply.category.EditForm.superclass.constructor.call(this,c);
	},
...
com.zz91.trade.supply.category.EditWin = function(code){
	var form = new com.zz91.trade.supply.category.EditForm({});
...
com.zz91.trade.supply.category.AddWin = function(code,text){
	var form = new com.zz91.trade.supply.category.EditForm();
	
	form.saveUrl = Context.ROOT + "/trade/tradesupply/createCategory.htm";
