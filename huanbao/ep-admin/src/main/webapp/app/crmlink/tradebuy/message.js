Ext.namespace("com.zz91.ep.linkMessage");
...
com.zz91.ep.linkMessage.gridField=[
...
com.zz91.ep.linkMessage.Grid=Ext.extend(Ext.grid.GridPanel,{
	targetType:"",
	constructor:function(config){
		...
		var _store=new Ext.data.JsonStore({
			...
			remoteSort:true,
			fields:com.zz91.ep.linkMessage.gridField,
			url:Context.ROOT+"/crmlink/crmlinktradebuy/queryMessage.htm?targetType="+_targetType,
			autoLoad:true
		});
		...
		com.zz91.ep.linkMessage.Grid.superclass.constructor.call(this,c);
	}
});

com.zz91.ep.linkMessage.Form = Ext.extend(Ext.form.FormPanel,{
	constructor:function(config){
		config = config||{};
		Ext.apply(this,config);
		...
		com.zz91.ep.linkMessage.Form.superclass.constructor.call(this,c);
	},
	loadOneRecord:function(id){
		...
		var _store = new Ext.data.JsonStore({
			fields : reader,
			url : Context.ROOT+ "/crmlink/crmlinktradebuy/queryOneMessage.htm",
			baseParams:{"id":id},
			autoLoad : true,
			listeners : {
