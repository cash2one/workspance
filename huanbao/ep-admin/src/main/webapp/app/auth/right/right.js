Ext.namespace("com.zz91.ep.auth.right");
...
/**
 * 添加权限窗口*/
com.zz91.ep.auth.right.AddFormWin = function(){
    var form = new com.zz91.ep.auth.right.FormPanel();
    form.saveUrl = Context.ROOT+"/auth/crmright/createRight.htm";
...
/**
 * 修改权限窗口*/
com.zz91.ep.auth.right.EditFormWin = function(){
    ...
    var form = new com.zz91.ep.auth.right.FormPanel();
    form.saveUrl = Context.ROOT+"/auth/crmright/updateRight.htm";
 ...
 * 权限表单面板
 */
com.zz91.ep.auth.right.FormPanel=Ext.extend(Ext.form.FormPanel,{
    constructor:function(config){
	    ...
	    com.zz91.ep.auth.right.FormPanel.superclass.constructor.call(this,c);
	},
	...
	saveUrl:Context.ROOT+"/auth/crmright/createRight.htm",
	/*保存表单*/
	...
	loadRight:function(){
	    ...
	    var _store = new Ext.data.JsonStore({
            root : "records",
            fields : _fields,
            url : Context.ROOT + "/auth/crmright/queryOneRight.htm?code="+node.attributes.data,
            autoLoad : true,
            listeners : {
