Ext.namespace("com.zz91.ep.util");
 ...
 * 类别下拉选择器
 * */
Ext.define("com.zz91.ep.util.CategoryCombo",{
 ...
 * 类别树选择器
 * */
Ext.define("com.zz91.ep.util.Tree",{
...
Ext.define("com.zz91.ep.util.TreeSelectorWin",{
	extend:"Ext.Window",
	initComponent:function(){
		
		var tree=Ext.create("com.zz91.ep.util.Tree",{
 ...
 * 上传对话框
 * */
Ext.define("com.zz91.ep.util.UploadWin",{
	extend:"Ext.Window",
	modal:true,
	width:400,
	autoHeight:true,
