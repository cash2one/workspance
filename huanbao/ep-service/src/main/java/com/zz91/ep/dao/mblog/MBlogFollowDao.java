...
*/
public interface MBlogFollowDao {
	/**
	 * 函数名称：insert
	 * 功能描述：添加关注账户信息
	 * 输入参数：
	 ...
	 * 　　　　　2013/10/23　　 fangchao 　　 　　 1.0.0　　 　　 创建方法函数
	 */
	 public List<MBlogFollow> queryFollowByIdAndType(Integer infoId,Integer type,PageDto<MBlogFollow> page);
	 /**
	 ...
	 * 　　　　　2013/10/23　　 fangchao 　　 　　 1.0.0　　 　　 创建方法函数
	 */
	 public List<MBlogFollow> queryFansByConditions(Integer targetId,PageDto<MBlogFollow> page);
	 /**
