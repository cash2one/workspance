...
public class BbsPostDO implements java.io.Serializable {
	...
	/** full constructor */
	public BbsPostDO(Integer id, Integer companyId, String account,Integer bbsUserProfilerId,
			Integer bbsPostCategoryId, Integer bbsTitleStyleId,
			Integer bbsTopicsId, String title, String content,
			Integer frontCategoryId, String isShow, String isDel,
			String checkPerson, String checkStatus, Date checkTime,
			String uncheckedCheckStatus, String unpassReason, String isHotPost,
			String postType, Integer visitedCount, Integer replyCount,
			Date postTime, Date gmtCreated, Date gmtModified) {
		this.id = id;
