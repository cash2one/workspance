...
//		try {
//			// D:/DEV/data/resources/periodical/doc/4b/Ambulance.png
//			// D:/DEV/data/resources/periodical/doc/4s/Ambulance.png
//			is.saveImageAsJpg(
//					"D:/DEV/data/resources/periodical/doc/4b/Ambulance.png",
//					"D:/DEV/data/resources/periodical/doc/4s/Ambulance.png",
//					79, 106);
//			is.saveImageAsJpg("f:/google.gif", "f:/google-small.gif", 200, 160);
//		} catch (Exception e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
		RemoteFileUtil util = new RemoteFileUtil("192.168.2.212","mays","c","data");
		SmbFile[] files = util.listFiles("resources/root/");
		try {
			for(SmbFile smbfile:files){
				SmbFile outputfile = util.smbFile("resources/rootthumb/"+smbfile.getName());
				is.saveImageAsJpgRemote(smbfile.getInputStream(), outputfile.getOutputStream(),
						200, 160);
			}
		} catch (IOException e) {
			e.printStackTrace();
	...
	public void saveImageAsJpgRemote(InputStream inputStream,
			OutputStream outputStream, int formatWideth, int formatHeight) 
			throws IOException {
		BufferedImage srcImage;
		...
		srcImage = imageZoomOut(srcImage, changeToWideth, changeToHeight);
		ImageIO.write(srcImage, "JPEG", outputStream);
	}
