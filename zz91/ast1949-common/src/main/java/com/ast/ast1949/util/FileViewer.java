...
//		D:/DEV/data/resources/periodical/doc/4b/
		List arrayList = FileViewer.getListFiles("D:/DEV/data/resources/periodical/doc/4b", null, false);
		...
		if (arrayList.isEmpty()) {
			...
			appendMethod("f:\\wceusbsh.inf", message);
		}
	}
