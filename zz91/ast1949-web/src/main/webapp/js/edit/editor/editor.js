...
EDiaryEditor = {
	initialize: function (sEditorID, sParentID, bWordMode, sContent,cHeight) {
		this.initView(sParentID,cHeight);
	...
	initView: function (sParentID,cHeight) {
		var _this = this;
		var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 621px;'>\
				...
				<div style='height: 100px; background-image: url(images/editor/guage.gif); padding-left: 39px; width: 582px!important ; width: 621px;' id='EDiaryEditorContent'>\
					<iframe id='editor_body_area' name='editor_body_area' style='width: 550px; height: "+cHeight+"px; border-width: 0px; overflow-x: atuo; display: nones;' frameborder='0'></iframe>\
					<textarea id='editor_body_textarea' name='editor_body' style='width: 548px; height: 102px; border-width: 0px; padding-top:8px; display: none;'></textarea>\
	...
	initControl: function (bWordMode, sContent) {
		...
		function viewDialog(el, Act) {
			...
			if(window._isIE) {
				...
				if(Act == "img") {
					window.showModalDialog("editor/img.html", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
				}
				if(Act == "link") {
					window.showModalDialog("editor/link.html", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
				}
				if(Act == "table") {
					window.showModalDialog("editor/table.html", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
				}
			}
			else {
				if(Act == "img") {
					win = window.open("editor/img.html", null, "Width=400,Height=200");
					win.dialogArguments = window;
				}
				if(Act == "link") {
					win = window.open("editor/link.html", null, "Width=400,Height=200");
					win.dialogArguments = window;
				}
				if(Act == "table") {
					win = window.open("editor/table.html", null, "Width=400,Height=200");
					win.dialogArguments = window;
				}
			}
