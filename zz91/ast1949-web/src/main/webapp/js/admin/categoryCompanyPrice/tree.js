...
ast.ast1949.admin.categoryCompanyPrice.treePanel=Ext.extend(Ext.tree.TreePanel,{
	rootData:"",
	constructor:function(config){
		...
		var treeLoad = new Ext.tree.TreeLoader({
			url:Context.ROOT+Context.PATH+"/admin/categorycompanyprice/child.htm",
			listeners:{
		...
		ast.ast1949.admin.categoryCompanyPrice.treePanel.superclass.constructor.call(this,c);
	}
});
