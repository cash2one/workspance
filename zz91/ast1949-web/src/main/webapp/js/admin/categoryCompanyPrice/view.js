...
Ext.onReady(function() {
		...
		var _url = Context.ROOT + "/zz91/admin/categorycompanyprice/edit.htm";

		var _editPanel = ast.ast1949.admin.categoryCompanyPrice.editPanel( {
   ...
   var _left = new Ext.Panel({
		...
		var _tree = ast.ast1949.admin.categoryCompanyPrice.treePanel( {
			el : "category-tree",
			rootData : ""
		});
		...
		function doDelete(_btn) {
			...
			conn.request( {
				url : Context.ROOT + Context.PATH
						+ "/admin/categorycompanyprice/delete.htm?code=" + code,
				method : "get",
				scope : this,
