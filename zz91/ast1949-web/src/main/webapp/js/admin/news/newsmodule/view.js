...
Ext.onReady(function(){
	var _url = Context.ROOT + "/zz91/admin/news/newsmodule/edit.htm";
	
	var _editPanel = ast.ast1949.admin.news.newsmodule.editPanel({
	...
	var _tree = ast.ast1949.admin.news.newsmodule.treePanel({el:"newsmodule-tree",rootData:""});
    ...
    function doDelete(_btn){
		...
		conn.request({
			url: Context.ROOT + Context.PATH + "/admin/news/newsmodule/delete.htm?id="+_id,
			method : "get",
			scope : this,
