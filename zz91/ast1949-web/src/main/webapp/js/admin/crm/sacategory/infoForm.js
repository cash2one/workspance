...
ast.ast1949.admin.crm.sacategory.InfoFormPanel = Ext.extend(Ext.Panel,{
	_form:null,
	constructor:function(_cfg){
		...
		var tree;
      	parentCombo.on("expand",function(){
      		if(tree==null){
	      		tree =  ast.ast1949.admin.crm.sacategory.treePanel({el:"category-combo",rootData:""});
		...
		ast.ast1949.admin.crm.sacategory.InfoFormPanel.superclass.constructor.call(this,{
			title:_title,
			closeable:true,
			width:700,
			autoHeight:true,
