...
Ext.onReady(function(){
	var _url = Context.ROOT + Context.PATH +"/admin/crm/sacategory/edit.htm";
	
	var _editPanel = ast.ast1949.admin.crm.sacategory.editPanel({
	...
	var _tree = ast.ast1949.admin.crm.sacategory.treePanel({el:"category-tree",rootData:""});
    ...
    function doDelete(_btn){
		...
		conn.request({
			url: Context.ROOT + Context.PATH + "/admin/crm/sacategory/delete.htm?id="+_id,
			method : "get",
			scope : this,
