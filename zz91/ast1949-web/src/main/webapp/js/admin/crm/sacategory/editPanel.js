...
ast.ast1949.admin.crm.sacategory.editPanel = function(_cfg){
	if(_cfg == null){
		_cfg = {};
	}
	...
	var isView = true;
	var notView = false;
	var panel = new ast.ast1949.admin.crm.sacategory.InfoFormPanel({
		title:title,
		view:isView,
		nView:notView,
	...
	var _store = new Ext.data.JsonStore({
		...
		url : Context.ROOT + Context.PATH + "/admin/crm/sacategory/getSimpleCategory.htm",
		autoLoad:true,
		listeners:{
	...
	function onSaveSuccess(){
		...
		Ext.getCmp("serve-added-category-form").getForm().reset();
