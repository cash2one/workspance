...
//	private Integer showIndex=0;  //类别序号
//	private String label;         //类别名称
//	private Date gmtCreated;
//	private Date gmtModified;
//
ast.ast1949.admin.categoryproducts.InfoFormPanel = Ext.extend(Ext.Panel,{
	_form:null,
	constructor:function(_cfg){
		...
		var tree;
      	parentCombo.on("expand",function(){
      		if(tree==null){
	      		tree =  ast.ast1949.admin.categoryproducts.treePanel({el:"category-combo",rootData:""});
...
//			}
		...
		ast.ast1949.admin.categoryproducts.InfoFormPanel.superclass.constructor.call(this,{
			title:_title,
			closeable:true,
			width:700,
			autoHeight:true,
