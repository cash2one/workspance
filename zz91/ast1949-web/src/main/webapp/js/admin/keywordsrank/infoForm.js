...
ast.ast1949.admin.keywordsrank.InfoFormWin = Ext.extend(Ext.Window, {
	_form : null,
	constructor : function(_cfg) {
			...
			items : [ {
				...
				items : [ {
					...
					items : [{
						...
						anchor : "95%",
						items :[
								{inputValue:"1",boxLabel:"是",name:"isChecked"},
		...
		ast.ast1949.admin.keywordsrank.InfoFormWin.superclass.constructor.call(
				this, {
					title : _title,
					closeable : true,
					width : 700,
