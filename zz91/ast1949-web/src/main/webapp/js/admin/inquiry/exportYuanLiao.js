...
ast.ast1949.admin.inquiry.ProductResultGrid = Ext.extend(Ext.grid.GridPanel, {
		...
		var _cm=new Ext.grid.ColumnModel([_sm,
			{
				...
				dataIndex : "title",
				renderer : function(value, metadata, record, rowIndex,colIndex, store) {
					return "<a href='"+Context.ROOT + Context.PATH + "/yuanliao/edit.htm?id="+record.get("id")+"&companyId="+record.get("companyId")+"' target='_blank'>"+value+"</a>"
				}
			},{
				header : "收件人",
				width : 80,
	...
	listRecord:Ext.data.Record.create([
		...
		{name:"details",mapping:"yuanliao.description"},
		{name:"productsTypeCode",mapping:"yuanliao.yuanliaoTypeCode"},
