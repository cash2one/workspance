		...
		var cm = new Ext.grid.ColumnModel([
			sm,{
				...
				renderer: function(value,metadata,record,rowIndex,colIndex,store){
			  	 ...
			  	 header : "前7天接听率",
			  	 width : 60,
			  	 dataIndex :"phoneRateForSevenDay",
			  	 renderer: function(value,metadata,record,rowIndex,colIndex,store){
					 return  value+"%";
				}
			},{
...
//		}
		{
			...
			iconCls:"add",
			handler:function(){
//				ast.ast1949.phone.addCRMLog(row.get("id"));
 ...
 * 重新分配客户信息
 * */
ast.ast1949.phone.reassign=function(grid, oldassignArr, cs, csname){
...
//				hiddenId:"expireFlag",
	...
	loadInit:function(id,companyId){
		...
		form.store = new Ext.data.JsonStore({
			fields : ast.ast1949.phone.PHONEINFOFIELD,
