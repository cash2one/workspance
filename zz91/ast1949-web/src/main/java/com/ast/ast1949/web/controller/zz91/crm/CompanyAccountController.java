...
public class CompanyAccountController extends BaseController {
	...
	@RequestMapping
	public ModelAndView queryAccount(HttpServletRequest request, Map<String, Object> out, CompanyAccount account, PageDto<CompanyDto> page) throws IOException{
		page=companyAccountService.queryAccountByAdmin(account, page);
