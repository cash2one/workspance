...
//		page.setRecords(inquiryService.queryInquiryByConditions(inquiryDto));
	 ...
	 */
	@RequestMapping
	public ModelAndView createInquiryForProductsByInquiry(Inquiry inquiryDO,
			String productsArray, Map<String, Object> model) throws IOException {
		ExtResult result = new ExtResult();
//		try {
//			inquiryService.insertInquiryForProductsByInquiry(inquiryDO, productsArray);
...
//		}
	 ...
	 */
	@RequestMapping
	public ModelAndView listProducts(PageDto<ProductsDto> page, Company company, ProductsDO products,
			Map<String, Object> model) throws IOException {
