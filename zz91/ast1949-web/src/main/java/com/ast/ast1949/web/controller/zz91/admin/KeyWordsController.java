...
public class KeyWordsController extends BaseController {
	...
	public ModelAndView query(Map<String, Object> model, PageDto<ProductsKeywordsRankDTO> page,String isChecked,Boolean expire,
		...
		if("金牌标王".equals(productsKeywordsRankDO.getType())){
			productsKeywordsRankDO.setType("10431000");
		}else if("银牌标王".equals(productsKeywordsRankDO.getType())){
			productsKeywordsRankDO.setType("10431001");
		}else if("铜牌标王".equals(productsKeywordsRankDO.getType())){
			productsKeywordsRankDO.setType("10431002");
		}
	...
	public ModelAndView queryById(Map<String, Object> model,Integer id) throws IOException{
		...
		if("10431000".equals(productsKeywordsRankDO.getType())){
			productsKeywordsRankDO.setType("金牌标王");
		}else if("10431001".equals(productsKeywordsRankDO.getType())){
			productsKeywordsRankDO.setType("银牌标王");
		}else if("10431002".equals(productsKeywordsRankDO.getType())){
			productsKeywordsRankDO.setType("铜牌标王");
		}
	...
	public ModelAndView save(Map<String, Object> model,ProductsKeywordsRankDO productsKeywordsRank) throws IOException {
		...
		if("金牌标王".equals(productsKeywordsRank.getType())){
			productsKeywordsRank.setType("10431000");
		}else if("银牌标王".equals(productsKeywordsRank.getType())){
			productsKeywordsRank.setType("10431001");
		}else if("铜牌标王".equals(productsKeywordsRank.getType())){
			productsKeywordsRank.setType("10431002");
		}else if("热门推荐".equals(productsKeywordsRank.getType())){
			productsKeywordsRank.setType("10431003");
		}
	 ...
	 */
	@RequestMapping
	public ModelAndView update(Map<String, Object> model,ProductsKeywordsRankDO productsKeywordsRank
