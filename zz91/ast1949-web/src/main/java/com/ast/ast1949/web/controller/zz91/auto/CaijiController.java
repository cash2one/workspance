...
//      return new ModelAndView("result");
    ...
    public ModelAndView caiji_feijiu(Integer feijiuTypeId,Map<String, Object> out) throws ParseException{
        ...
        try {
            ...
            out.put("linkContent", e.toString());
        }
        if(content==null){
            break;
        }
        Integer start = content.indexOf("废塑料价格行情</p>");
        Integer end = content.indexOf("<!-- AspNetPager V7.0 for VS2008  Copyright:2003-2007 Webdiyer (www.webdiyer.com) -->");
        if(start>=end){
...
//          resultContent = resultContent.toLowerCase();
    ...
    /**
     * 新干线
     * http://www.96369.net/news/news_list.aspx?channelid=2&columnid=9
     * @return
     * @throws ParseException 
     */
    @RequestMapping
    public ModelAndView caiji_XGX(Integer typeId, Map<String, Object> out)
            throws ParseException {
        do {
...
//          String result = getListContent(ALBB_YS_MAP, typeId);
                ...
                for(String aStr:list){
                    ...
                    if(StringUtils.isEmpty(linkStr)){
                        ...
                        if(alink.length>0){
                            ...
                            /* String str1 = resultContent.substring(0, resultContent.indexOf("<tr"));
                            String str2 = resultContent.substring(resultContent.indexOf("</tr")+5,resultContent.length());
                            out.put("resultContent", resultContent);
    ...
    static{
        ...
        FB_MAP.put("40", "channelID=43,44&categoryID=135,48|" +
        ...
        FB_MAP.put("52", "channelID=45,46,34&categoryID=135,48|" +
                "channelID=45,46,34&categoryID=135,50|" +
                "channelID=45,46,34&categoryID=135,51|" +
                "channelID=45,46,34&categoryID=135,53|" +
                "channelID=45,46,34&categoryID=135,54");
        FB_MAP.put("43", "channelID=45,46,34&categoryID=135,48|" +
                "channelID=45,46,34&categoryID=135,50|" +
                "channelID=45,46,34&categoryID=135,49");
        FB_MAP.put("308", "channelID=45,46,34&categoryID=135,48|" +
                "channelID=45,46,34&categoryID=135,50");
     ...
     */
    @RequestMapping
    public ModelAndView caiji_fb(Integer typeId, Map<String, Object> out) throws ParseException, URISyntaxException, ClientProtocolException, IOException {
        do {
            String content = "";
            ...
            for(String urlStr:urlArray){
                ...
                for (String s : str) {
                    if (s.indexOf(format) != -1 || s.indexOf(formatZero) != -1) {
                        if(typeId==40){
                            if(s.indexOf("临沂市场废铜价格")!=-1||s.indexOf("江苏市场废铜价格")!=-1||s.indexOf("上海市场废铜价格")!=-1||s.indexOf("河北市场废铜")!=-1){
                                list.add(s);
                            }
                        }
                        if(typeId==41){
                        ...
                        if(typeId==52){
                            if(s.indexOf("山东市场废电瓶")!=-1||s.indexOf("浙江市场废电瓶")!=-1||s.indexOf("广东市场废电瓶")!=-1||s.indexOf("河南市场废电瓶")!=-1||s.indexOf("四川市场废电瓶")!=-1||s.indexOf("重庆市场废电瓶")!=-1||s.indexOf("陕西市场废电瓶")!=-1){
                                list.add(s);
                            }
                        }
                        if(typeId==43){
...
//                          resultContent = resultContent.toLowerCase();
                            ...
                            if(resultContent.indexOf("<p> 富宝资讯")!=-1&& resultContent.indexOf("<p>富宝资讯免责声明")!=-1){
                                resultContent = subContent(resultContent, resultContent.indexOf("<p> 富宝资讯"), resultContent.indexOf("<p>富宝资讯免责声明"));
                            }else if(resultContent.indexOf("<table")!=-1&& resultContent.indexOf("</table>")!=-1){
                                resultContent = subContent(resultContent, resultContent.indexOf("<table"), resultContent.indexOf("</table>")+8);
                            }
    ...
    static{
        ...
        ZS_MAP.put("233", "http://www.l-zzz.com/plastic/list.jsp?nChannelID=487,"
        ...
        ZS_MAP.put("listStart", "<td width=\"67%\"  background=\"../images/09new/list_4.gif\" ><img src=\"../images/09new/list_3.gif\" width=\"36\" height=\"28\" /></td>"); // 列表页开头
     ...
     */
    @RequestMapping
    public ModelAndView caiji_lzzz(Integer typeId, Map<String, Object> out)
            throws ParseException {
        do {
            String content = "";
...
//                          resultContent = resultContent.toLowerCase();
    ...
    static{
        ...
        CNAL_METAL_MAP.put("216", "http://market.cnal.com/other/index.shtml," +
                "http://market.cnal.com/other/index_2.shtml," + 
                "http://market.cnal.com/other/index_3.shtml");
    ...
    @RequestMapping
    public ModelAndView caiji_cnal_metal(Integer typeId, Map<String, Object> out)
            throws ParseException {
        do {
            String content = "";
    ...
    @RequestMapping
    public ModelAndView caiji_ometal_metal(Integer typeId, Map<String, Object> out)
            throws ParseException {
        do {
            String content = "";
    ...
    @RequestMapping
    public ModelAndView caiji_albb_iron(Integer typeId,Map<String, Object> out) throws ParseException, URISyntaxException ,ClientProtocolException, IOException{
        do {
...
//      return new ModelAndView("result");
    ...
    static{
        ...
        PLASTIC_MAP.put("url", "http://www.l-zzz.com/plastic/list.jsp?nChannelID=260,"
    ...
    static{
        ...
        RECYCLEDPLASTIC_MAP.put("98", "http://info.1688.com/nlist/n90.html," +
                ...
                "http://info.1688.com/nlist/n78.html");
    ...
    @RequestMapping
    public ModelAndView caiji_albb_recycledPlasticOne(Integer typeId, Map<String, Object> out)
            throws ParseException {
        do {
            String content = "";
...
//                          resultContent = resultContent.toLowerCase();
    ...
    @RequestMapping
    public ModelAndView caiji_albb_recycledPlasticTwo(Integer typeId, Map<String, Object> out)
            throws ParseException {
        do {
            String content = "";
...
//                          resultContent = resultContent.toLowerCase();
    ...
    @RequestMapping
    public ModelAndView caiji_cs_discussMorning(Integer typeId,Map<String, Object> out) throws ParseException,URISyntaxException, ClientProtocolException, IOException{
        do {
    ...
    @RequestMapping
    public ModelAndView caiji_cs_discussEvening(Integer typeId,Map<String, Object> out) throws ParseException,URISyntaxException, ClientProtocolException, IOException{
        do {
        ...
        /*标题没有抓取信息标签而内容有的情况
         * 主要做法：将网页内容全部抓取，根据信息标签查看内容是否有，如果有，则将该篇放如该信息标签中*/
        if (typeId == 34) {
            while (!(strContent.contains("连塑") && (strContent.contains("PVC") || strContent.contains("pvc")) && (strContent.contains("PTA")
                    || strContent.contains("pta")))) {
    ...
    @RequestMapping
    public ModelAndView caiji_ometal_LME(Integer typeId,Map<String, Object> out) throws ParseException,URISyntaxException, ClientProtocolException, IOException {
        do {
        ...
        for (String s:str) {
            ...
            if(s.indexOf(formatDate)!=-1){
                    if ((s.contains("LME基本金属最新报价") && (s.contains("9:50") || s.contains("11:50") || s.contains("14:50")))
        ...
        for (String link:list) {
            ...
            if(alink.length>0){
                ...
                resultContent = resultContent.replace("\n ", "");
                resultContent = resultContent.replace("(全球金属网", "");
                //resultContent = resultContent.replace("<br /> <br />", "<br /><br />");
...
//                System.out.println(week);
     ...
     */
    @RequestMapping 
    public ModelAndView caiji_lzzz_oilexpress(Integer typeId,Map<String, Object>out) throws ParseException, URISyntaxException{
        do {
            String content ="";
            try {
...
//                      resultContent = resultContent.toLowerCase();
     ...
     */
    @RequestMapping
    public ModelAndView caiji_lzzz_oilcity(Integer typeId,Map<String, Object>out) throws ParseException, URISyntaxException{
        do {
            String content ="";
            try {
...
//                      resultContent = resultContent.toLowerCase();
    ...
    @RequestMapping
    public ModelAndView caiji_shfe(Integer typeId, Map<String, Object> out)
                    ...
                    if(alink.length>0){
                        ...
                        if (resultTitle.contains("江苏") || resultTitle.contains("浙江") || resultTitle.contains("上海")) {
                            ...
                            if (tag == 3) {
                                ...
                                resultContent = resultContent.replace("<div>", "<table><tr><td>地区</td><td>品种</td><td>最低价</td><td>最高价</td></tr><tr><td>");
                                resultContent = resultContent.replace("<br>", "</td></tr><tr><td>");
                                resultContent = resultContent.replace(" ", "</td><td>");
                                resultContent = resultContent.replace("</div>", "</td></tr></table>");
                                resultContent = resultContent.replace("<td></td>", "");
                            ...
                            resultContent = resultContent.replace("/", " ");
                            resultContent = resultContent.replace("< div>", "</div>");
                            resultContent = resultContent.replace("<div>", "<table><tr><td>地区</td><td>品种</td><td>最低价</td><td>最高价</td></tr><tr><td>" + title + "</td><td>");
...
//                      resultContent = resultContent.toLowerCase();
     ...
     */
    @RequestMapping
    public ModelAndView caiji_albb_petrifaction(Integer typeId,Map<String, Object>out) throws ParseException,URISyntaxException, ClientProtocolException, IOException{
        do {
            String content ="";
            try {
            ...
            for (String s : str) {
                if (s.indexOf(formatDate) != -1) {
                    if(s.contains("企业PVC<font color=red>出厂价") || s.contains("企业ABS<font color=red>出厂价") || s.contains("企业PP<font color=red>出厂价")
                            || s.contains("LLDPE<font color=red>出厂价") || s.contains("企业LDPE<font color=red>出厂价") || s.contains("企业HDPE<font color=red>出厂价")
...
//                      resultContent = resultContent.toLowerCase();
     ...
     */
    @RequestMapping
    public ModelAndView caiji_feijiu_pager(Integer typeId,Map<String, Object>out) throws ParseException,URISyntaxException, ClientProtocolException, IOException{
        do {
            String content ="";
            try {
...
//                      resultContent = resultContent.toLowerCase();
     ...
     */
    @RequestMapping
    public ModelAndView caiji_lzzz_domesticrubber(Integer typeId,Map<String, Object>out) throws ParseException,URISyntaxException, ClientProtocolException, IOException{
        do {
            String content ="";
            try {
...
//                      resultContent = resultContent.toLowerCase();
     ...
     */
    @RequestMapping
    public ModelAndView caiji_feijiu_eachcountry(Map<String, Object>out) throws ParseException,URISyntaxException, ClientProtocolException, IOException{
        do {
            String content = "";
...
//  }
    ...
    private Integer doInsert(PriceDO priceDO,Boolean isUpDown) throws ParseException{
        ...
        if (parentId != null) {
            ...
            List<PriceCategoryDO> newsCategory = priceCategoryService
        ...
        if(isUpDown){
            ...
            priceDO.setContent(priceDO.getContent() + priceService.buildTemplateContent(priceSearchKey, zaobaoSearchKeyString, wanbaoSearchKeyString, code));
        }else{
            priceDO.setContent(priceDO.getContent() + priceService.queryContentByPageEngine(priceSearchKey,zaobaoSearchKeyString,wanbaoSearchKeyString));
        }
        ...
        if (impress != null && impress > 0) {
            ...
            LogUtil.getInstance().mongo(
                    "admin-auto",PRICE_OPERTION,null,"{'id':'" + impress + "','date':'"
    ...
    private String httpClientHtml(String url , String strCharset) throws URISyntaxException, ClientProtocolException, IOException{
...
//      }
    ...
    //读取网页中list全部的内容
    private List<Map<String,String>> httpClientAllConten(Map<String, String>map , String formatDate) throws URISyntaxException, ClientProtocolException, IOException{
        DefaultHttpClient httpclient = new DefaultHttpClient();
    ...
    private String getDateFormatTitle(String title){
        do {
            ...
            for (int i=0;i<resultArray.length;i++) {
                ...
                } else  if (resultArray[i].length() > 2) {   //判断如果日期在后面则直接返回title。开发者：周宗坤 修改日期：2013-09-11
...
//      System.out.println(HttpUtils.getInstance().httpGet("http://www.f139.com/news/list.do?channelID=43,44", "utf-8"));
//      System.out.println(HttpUtils.getInstance().httpGet("http://www.f139.com", "utf-8"));
//      NameValuePair
//      NameValuePair[] data = { new NameValuePair("channelID", "43,44"), new NameValuePair("categoryID", "135,48")};
//      String content = HttpUtils.getInstance().httpPost("http://www.f139.com/news/list.do?", data, HttpUtils.CHARSET_DEFAULT);
