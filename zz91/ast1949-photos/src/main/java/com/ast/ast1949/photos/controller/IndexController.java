...
public class IndexController extends BaseController {
	...
	@RequestMapping
	public ModelAndView searchPic(String searchKey, Map<String, Object> out,
			PageDto<ProductsDto> page, String mainCode) throws Exception {
		// s代表是否搜索出数据
		// 根据搜索兰提交的关键字搜索数据
	...
	public ModelAndView queryPicInfoById(Integer productId,Map<String, Object> out, String string) throws Exception {
		...
		out.put("productsPicDOList", productsPicDOList);
