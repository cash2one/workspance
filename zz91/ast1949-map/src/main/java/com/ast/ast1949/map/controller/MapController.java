...
//		page = priceService.queryPricePaginationListByTitle(keywords, page);
	...
	public void list(Map<String, Object> out, String productType,
		...
		if ("p".equals(listType)) {
			// 优质供求
//			out.put("page", mapService.pageHotProductsByArea(productCode,
//					areaKey, keywords, null, 10, page));
			page.setPageSize(10);
			out.put("page", mapService.queryBySearchEnegine(areaKey, keywords,
					productCode, page));
		} else {
			// 优质客户
			out.put("page", mapService.pageHotCompanysByArea(productCode,
					areaKey, keywords, 10, page));
		}
