...
//		return new ModelAndView ("redirect:http://pyapp.zz91.com/zz91register/");
	 ...
	 */
	@RequestMapping
	public ModelAndView register_stp2(HttpServletRequest request, HttpServletResponse response, Map<String, Object> out, 
			String refurl, String token, String verifyCode, String password, String passwordConfirm,
			Company company, CompanyAccount companyAccount)throws Exception {
		//检测同一个IP是否频繁注册?
