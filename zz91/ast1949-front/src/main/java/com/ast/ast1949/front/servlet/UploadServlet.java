...
//			u.setTmpFolder(String.valueOf(MemcachedUtils.getInstance().getClient().get("baseConfig.upload_folder_temp")));
...
//			return String.valueOf(MemcachedUtils.getInstance().getClient().get("baseConfig.upload_folder"))
//				+"/"+getModel(request)+"/";
//		}
//		return String.valueOf(MemcachedUtils.getInstance().getClient().get("baseConfig.upload_folder"))
...
//		Integer i = Integer.valueOf(String.valueOf(MemcachedUtils.getInstance().getClient().get("baseConfig.upload_size_max")));
