...
ddaccordion.init({
	headerclass: "myheader", //Shared CSS class name of headers group
	contentclass: "mycontent", //Shared CSS class name of contents group
	...
	togglehtml: ["src", "../../../images/service/helpcenter/plus.gif", "../../../images/service/helpcenter/minus.gif"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
