...
temp+="<option value='12' title=1401 class=2>定州废塑料集散中心</option>";
temp+="<option value='64' title=1401 class=2>保定废塑料集散中心</option>";
temp+="<option value='65' title=1401 class=1>保定废金属集散中心</option>";
temp+="<option value='66' title=1410 class=1>邢台废金属集散中心</option>";
temp+="<option value='67' title=1402 class=3>任丘（玉田）再生胶集</option>";
temp+="</select>";
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='31' title=2202 class=2>蚌埠五河废塑料集散地</option>";
temp+="<option value='54' title=2206 class=1>界首田营金属集散中心</option>";
temp+="<option value='80' title=2206 class=2>界首废塑料集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '23':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='50' title=2309 class=1>漳州全通金属园区</option>";
temp+="<option value='81' title=2306 class=2>南安废塑料集散地</option>";
temp+="<option value='82' title=2309 class=2>漳州废塑料集散中心</option>";
temp+="<option value='83' title=2302 class=2>漳平市废塑料集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '25':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='99' title=2514 class=1>双兴废金属集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '28':
...
temp+="<option value='85' title=2804 class=1>中州（铝材）市场</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '29':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='92' title=2916 class=2>汉川废塑料集散中心</option>";
temp+="<option value='93' title=2917 class=1>宜昌（再生铅）集散地</option>";
temp+="<option value='94' title=2912 class=2>青山废塑料</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '30':
...
temp+="<option value='86' title=3012 class=2>汨罗废塑料集散地</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '16':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='101' title=1604 class=3>演武废橡胶集散地</option>";
temp+="<option value='100' title=1604 class=3>平遥废橡胶集散地</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '18':
...
temp+="<option value='72' title=1814 class=2>营口废塑料集散中心</option>";
temp+="<option value='73' title=1810 class=2>锦州废塑料集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '32':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='95' title=3211 class=2>龙潭废塑料集散中心</option>";
temp+="<option value='96' title=3211 class=1>龙潭废金属集散中心</option>";
temp+="<option value='97' title=3213 class=1>梧州废金属集散地</option>";
temp+="<option value='98' title=3213 class=2>梧州废塑料集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '34':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='91' title=3403 class=1>新津废金属集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '11':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='62' title=1101 class=1>曹安市场</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '12':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='36' title=1201 class=1>静海废金属集散中心</option>";
temp+="<option value='53' title=1201 class=1>子牙废金属</option>";
temp+="<option value='63' title=1201 class=2>静海废塑料集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '27':
...
temp+="<option value='48' title=2708 class=1>聊城废金属集散中心</option>";
temp+="<option value='60' title=2715 class=2>龙口废塑料集散地</option>";
temp+="<option value='27' title=2715 class=2>莱州废塑料集散地</option>";
temp+="<option value='26' title=2709 class=2>临沂废塑料集散地</option>";
temp+="<option value='84' title=2705 class=2>章丘废塑料集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '31':
...
temp="<select name='"+Fname2+"' id='"+Fname2+"' style='"+Fstyle+"'  onChange=selectOption('"+Fname1+"',this.options[this.selectedIndex].title)>";
temp+="<option value=''>请选择...</option>";
temp+="<option value='32' title=3103 class=2>杏坛废塑料集散地</option>";
temp+="<option value='34' title=3103 class=2>南海废塑料集散地</option>";
temp+="<option value='45' title=3103 class=1>南海废金属集散地</option>";
temp+="<option value='61' title=3112 class=6>贵屿废旧电子集散地</option>";
temp+="<option value='87' title=3112 class=2>贵屿废塑料集散地</option>";
temp+="<option value='88' title=3112 class=1>贵屿废金属集散地</option>";
temp+="<option value='89' title=3103 class=2>乐从废塑料集散地</option>";
temp+="<option value='90' title=3118 class=1>吴川废金属集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '15':
...
temp+="<option value='42' title=1506 class=1>宁波废金属集散中心</option>";
...
temp+="<option value='68' title=1509 class=2>温州废塑料集散中心</option>";
temp+="<option value='69' title=1509 class=4>宜山布料集散中心</option>";
temp+="<option value='70' title=1503 class=1>嘉善废金属集散中心</option>";
temp+="<option value='71' title=1509 class=3>温州再生胶集散地</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
case '21':
...
temp+="<option value='14' title=2112 class=1>扬州废金属集散地</option>";
...
temp+="<option value='74' title=2113 class=2>丹阳废塑料集散中心</option>";
temp+="<option value='75' title=2105 class=2>南通废塑料集散中心</option>";
temp+="<option value='76' title=2111 class=2>盐城废塑料集散中心</option>";
temp+="<option value='77' title=2106 class=1>吴江金属集散中心</option>";
temp+="<option value='78' title=2105 class=3>南通再生胶集散中心</option>";
temp+="</select>";
document.getElementById("main"+Fname2+"").innerHTML=""+temp+"";
break;
default:
