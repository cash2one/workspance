...
TransformView.prototype = {   
  //容器对象,滑动对象,切换参数,切换数量   
  initialize: function(container1, slider, parameter, count, options) {   
    if(parameter <= 0 || count <= 0) return;   
    var oContainer = $(container1), oSlider = $(slider), oThis = this;   
...
window.onload=function(){   
    ...
    var tv2 = new TransformView("idTransformViewb2", "idSliderb2", 945, 3, {   
