...
public class ProductsDAOImpl extends BaseDaoSupport implements ProductsDAO {
	...
	public List<ProductsDto> queryProductsWithCompanyForInquiry(
		...
		return getSqlMapClientTemplate()
				.queryForList(
						addSqlKeyPreFix(sqlPreFix,
								"queryProductsWithCompanyForInquiry"), root);
	}
	...
	public List<ProductsDto> queryProductsByAdmin(Company company,
		...
		return getSqlMapClientTemplate().queryForList(
				addSqlKeyPreFix(sqlPreFix, "queryProductsByAdmin"), root);
	}
	...
	public Integer queryProductsByAdminCount(Company company,
		...
		root.put("selectTime", selectTime);
		return (Integer) getSqlMapClientTemplate().queryForObject(
				addSqlKeyPreFix(sqlPreFix, "queryProductsByAdminCount"), root);
	}
	...
	public List<ProductsDO> queryNoRepeatProducts(String industryCode,String areaCode,String keywords,String typeCode,PageDto<ProductsDto>page) {
		...
		return getSqlMapClientTemplate().queryForList(addSqlKeyPreFix(sqlPreFix, "queryNoRepeatProducts"), map);
	}
	...
	public Integer countQueryNoRepeatProducts(String industryCode,String areaCode,String keywords,String typeCode) {
		...
		map.put("keywords", keywords);
		map.put("typeCode", typeCode);
		return (Integer) getSqlMapClientTemplate().queryForObject(addSqlKeyPreFix(sqlPreFix, "countQueryNoRepeatProducts"), map);
	}
