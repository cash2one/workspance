...
public interface CompanyPriceDAO {
	 ...
	 */
    public  List<CompanyPriceDO> queryCompanyPriceForAdmin(String title,String isChecked,String categoryCode,PageDto<CompanyPriceDO> page);
    /**
     *        获取后台企业报价总记录数
     * @param companyPriceDTO 不能为空
     * @return  返回记录总数
     */
    public Integer queryCompanyPriceCountForAdmin(String title,String isChecked,String categoryCode);
	/**
	 *   根据登录者查询 企业报价
	 * @param companyId
	 * @return  结果集
