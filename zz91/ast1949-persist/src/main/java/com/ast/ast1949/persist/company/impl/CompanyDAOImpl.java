...
public class CompanyDAOImpl extends BaseDaoSupport implements CompanyDAO {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Company> queryBlackList(Company company,CompanyAccount companyAccount,String reason,PageDto<CompanyDto> page) {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	@Override
	public Integer queryCountBlackList(Company company,CompanyAccount companyAccount,String reason) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("company", company);
		map.put("companyAccount", companyAccount);
		map.put("reason", reason);
	...
	public Integer updateRegFromCode(Integer id, String code) {
		...
		return getSqlMapClientTemplate().update(
				addSqlKeyPreFix(SQL_PREFIX, "updateRegFromCode"), root);
	}
