...
public class ProductsPicServiceImpl implements ProductsPicService {
	...
	public Integer updateProductsPicIsDefault(ProductsPicDO productsPicDO) {
		...
		// 其他图片设置为非默认
		productsPicDAO.updateIsDefaultByProductId(productsPicDO.getProductId(),IS_NOT_DEFAULT);
		// 更新图片为默认
	...
	public List<ProductsPicDO> queryProductPicInfoByProductsIdForFront(Integer productId) {
		Assert.notNull(productId, "The productId can not be null");
		return productsPicDAO.queryProductPicInfoByProductsIdForFront(productId);
	}
	...
	public Integer batchUpdatePicStatus(String ids, String unpassReason,
		...
		return productsPicDAO.batchUpdatePicStatus(StringUtils.StringToIntegerArray(ids), checkStatus, unpassReason);
	}
	...
	public Integer batchUpdatePicStatusByProductId(Integer productId,
		...
		List<ProductsPicDO> list = productsPicDAO.queryProductPicInfoByProductsId(productId);
		String ids ="";
