...
public interface LogOperationService {
	...
	public Integer addOneOperation(Integer targetId,String operator,String operation,String remark);

	public PageDto<LogOperation> pageLogOperationByTargetIdAndOperation(Integer id, String operation, PageDto<LogOperation> page);
