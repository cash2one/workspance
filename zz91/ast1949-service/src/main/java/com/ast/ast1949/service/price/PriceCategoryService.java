...
public interface PriceCategoryService {
	...
	public Integer insertPriceCategory(PriceCategoryDO priceCategory) throws IllegalArgumentException;
	/**
	 * 删除一条资讯类别记录
...
//	public Integer batchDeletePriceCategoryById(int[] entities);
	 ...
	 * @throws IllegalArgumentException
	 */
	public Integer updatePriceCategoryById(PriceCategoryDO priceCategory) throws IllegalArgumentException;
	/**
	 * 读取指定资讯类别记录
	 * @param id 不能为null或"",且必须为整形，否则抛出异常;<br/>
	 * @return 资讯类别信息
	 ...
	 */
//	public List<PriceCategoryDO> queryPriceCategoryByCondition(PriceCategoryDTO priceCategoryDto);
	/**
	 * 按条件查询资讯类别总数
	 * @param priceCategoryDto
	 * @return 返回类别总数,没有数据时返回“0”.
	 */
//	public Integer getPriceCategoryRecordConutByCondition(PriceCategoryDTO priceCategoryDto);
...
//	public List<PriceCategoryDTO> getPriceCategoryByParentId(Integer id) throws IllegalArgumentException;
	
	/**
	 * 根据某节点的父节点ID读取所有父节点类别记录
	 * @param parentId 不能为null或"",且必须为整形，否则抛出异常;<br/>
	 * 父类别ID
	 * @return 资讯类别信息
	 * @throws IllegalArgumentException
	 */
	
	public List<PriceCategoryDO> getAllParentPriceCategoryByParentId(Integer parentId) throws IllegalArgumentException;
