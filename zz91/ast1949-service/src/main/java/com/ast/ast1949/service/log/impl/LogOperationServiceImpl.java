...
public class LogOperationServiceImpl implements LogOperationService {
	...
	public PageDto<LogOperation> pageLogOperationByTargetIdAndOperation(
		...
		page.setTotalRecords(logOperationDao.queryCountByTargetIdAndOperation(id, operation));
		page.setRecords(logOperationDao.queryByTargetIdAndOperation(id,operation, page));
		return page;
	}
