...
public interface ProductsPicService {
	...
	public Integer batchUpdatePicStatus(String ids, String unpassReason,String checkStatus);

	public Integer batchUpdatePicStatusByProductId(Integer productId, String unpassReason,String checkStatus);
