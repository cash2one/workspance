...
public class CrmCompanySvrServiceImpl implements CrmCompanySvrService {
	...
	public PageDto<CrmCompanySvrDto> pageApplyCompany(String svrCode,
		...
		page.setRecords(crmCompanySvrDao.queryApplyCompany(svrCode,
				applyStatus, companyId, page));
		page.setTotalRecords(crmCompanySvrDao.queryApplyCompanyCount(svrCode,
	...
	public Boolean openZstSvr(CrmCompanySvr svr, String domainZz91,
		...
		companyDAO.updateZstOpenInfo(svr.getCompanyId(), zstYear, domainZz91,
				membershipCode);
