...
public interface FriendLinkService {
	 ...
	 *          无记录：返回null
	 */
	public List<FriendLinkDTO> queryFriendLinkByCondition(FriendLinkDTO friendLinkDTO);
