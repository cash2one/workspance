...
public interface BbsService {
	...
	final static Map<Integer, String> BBS_POST_CATEGORY_MAP =new HashMap<Integer,String>();
	...
	public List<Map<String, Object>> queryTopPost(Integer categoryId, Integer size);
