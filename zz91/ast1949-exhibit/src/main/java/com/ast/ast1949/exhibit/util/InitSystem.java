 ...
 * Created on 2010-2-7
 */
package com.ast.ast1949.exhibit.util;
...
//		MemberRuleFacade.getInstance().init(memberRuleService.queryMemberRuleList(), null);
		...
		//初始化页面seo
		SeoUtil.getInstance().init("seo.properties");
	}
...
//			List<Param> paramList = paramService.listParamByTypes(type.getKey());
//			if (paramList != null) {
...
//		}
//
//		MemcachedFacade.getInstance().set(ParamFacade.CACHE_KEY, ParamFacade.EXPIRATION, paramCache);
