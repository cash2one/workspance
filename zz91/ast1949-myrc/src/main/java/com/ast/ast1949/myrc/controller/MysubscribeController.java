...
//		CompanyContactsDO ccd = companyContactsService.queryContactByAccount(sessionUser.getAccount());
	...
	@SuppressWarnings("unchecked")
	@RequestMapping
	public void myfavorite(MyfavoriteDTO myfavoriteDTO,  PageDto page, String favoriteTypeCode,
...
//		out.put("priceList", priceList);
	...
	public void favorites(HttpServletRequest request,Map<String, Object> out,
			PageDto<MyfavoriteDTO> page,String favoriteTypeCode,Integer theday,String keywords) throws UnsupportedEncodingException{
		SsoUser sessionUser = getCachedUser(request);
		//查询是否开通商铺服务
		myrcService.initMyrc(out, sessionUser.getCompanyId());
...
//		page.setPageSize(5);
	...
	public ModelAndView toCollectPage(HttpServletRequest request,
		...
		do{
			//明星
			if("10091010".equals(favoriteTypeCode)){
				url = AddressTool.getAddress("mingxing")+"/detail"+contentId+"-t.htm";
				break;
			}
			// trade
			...
			// huzhu 
			if("10091005".equals(favoriteTypeCode)){
	...
	@RequestMapping
	public void manageSubscribeSms(Map<String, Object> out,HttpServletRequest request,String categoryCode) throws HttpException, IOException{
		SsoUser sessionUser = getCachedUser(request);
		CompanyAccount companyAccount = companyAccountService.queryAccountByAccount(sessionUser.getAccount());
		out.put("currentEmail", companyAccountService.currentEmail(companyAccount));
	...
	public ModelAndView smsList(Map<String, Object> out,HttpServletRequest request,
			String categoryCode,String areaNodeId,Integer startIndex,Integer total) throws HttpException, IOException{
		SsoUser sessionUser = getCachedUser(request);
		CompanyAccount companyAccount = companyAccountService.queryAccountByAccount(sessionUser.getAccount());
		out.put("companyAccount", companyAccount);
		//定制的短信
