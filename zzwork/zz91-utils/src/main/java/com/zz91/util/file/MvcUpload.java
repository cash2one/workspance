...
public class MvcUpload {
	...
	final static String DEFAULT_ROOT="/mnt/data/resources";
	final static String DEFAULT_SERVER = "/mnt/data";
	...
	public static String getDestRootByServer(String server){
		return DEFAULT_SERVER+"/" + server;
	}
