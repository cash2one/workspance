...
public class SmsUtil {
	...
	public void sendSms(String templateCode, String receiver, Date gmtSend,
		...
		try {
			...
			NameValuePair[] data = {
					new BasicNameValuePair("templateCode", templateCode),
					new BasicNameValuePair("receiver", receiver),
					new BasicNameValuePair("gmtSendStr", DateUtil.toString(gmtSend,
							"yyyy-MM-dd HH:mm:ss")),
					new BasicNameValuePair("gatewayCode", gatewayCode),
					new BasicNameValuePair("priority", priority.toString()),
					new BasicNameValuePair("content", content),
					new BasicNameValuePair("smsParameter", js.toString()) };
	 ...
	 *            网关编号
	 */
	public void sendSms(String receiver, String content,String gatewayCode) {
		sendSms(null, receiver, null, gatewayCode, PRIORITY_DEFAULT, content, null);
	}
