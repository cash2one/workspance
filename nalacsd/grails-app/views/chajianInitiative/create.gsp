...
<html>
    <head>
        ...
        <title><g:message code="default.create.label" args="['主动查件记录']" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="default.create.label" args="['主动查件记录']" /></h1>
                        ...
                        <tbody>
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: chajianInitiativeInstance, field: 'store', 'errors')}">
                                    <g:select name="store.id" from="${com.nala.csd.Store.list()*.name}" keys="${com.nala.csd.Store.list()*.id}" value="${chajianInitiativeInstance?.store?.id}" noSelection="['':'']" />
                                </td>
                            </tr>
