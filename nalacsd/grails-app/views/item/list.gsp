                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="sku" title="${message(code: 'item.sku.label', default: 'Sku')}" />
                        
                            <g:sortableColumn property="code" title="${message(code: 'item.code.label', default: 'Code')}" />
                        
                            <g:sortableColumn property="num" title="${message(code: 'item.num.label', default: 'Num')}" />
                    ...
                    <g:each in="${itemInstanceList}" status="i" var="itemInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: itemInstance, field: "sku")}</td>
                        
                            <td>${fieldValue(bean: itemInstance, field: "code")}</td>
                        
                            <td>${fieldValue(bean: itemInstance, field: "num")}</td>
