...
<tr class="returnGoods">
	...
	<g:if test="${tmallShouhouInstance?.returnGoods?.postageNum }"><td valign="top" class="value"><g:textField name="postageNumStr" value="${tmallShouhouInstance?.returnGoods?.postageNum/100 }" />(元)</td></g:if>
