...
<tr class="refund" style="display: none;">
	...
	<td valign="top" class="value"><g:textField name="refundNumProductStr"
			value="${tmallShouhouInstance?.refund?.refundNumProduct }" />(元)</td>
</tr>
<tr class="refund" style="display: none;">
    <td valign="top" class="name"><label>退款金额(邮费)(售后)</label>
    </td>
    <td valign="top" class="value"><g:textField name="refundNumPostageStr"
                                                value="${tmallShouhouInstance?.refund?.refundNumPostage }" />(元)</td>
</tr>
<tr class="refund" style="display: none;">
