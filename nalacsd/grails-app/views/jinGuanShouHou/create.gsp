...
<html>
    <head>
        ...
        <title><g:message code="default.create.label" args="['金冠店售后登记记录']" /></title>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="list" action="list">金冠店售后登记记录列表</g:link></span>
        </div>
        <div class="body">
            <h1>新增金冠售后登记记录</h1>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: jinGuanShouHouInstance, field: 'solveCS', 'errors')}">
                                    %{--<g:if test="${jinGuanShouHouInstance?.solveCS?.id }">--}%
                                    ...
                                    %{--</g:if>--}%
                                    %{--<g:else>--}%
                                        %{--<g:select name="solveCS.id" from="${com.nala.csd.Hero.list()*.name}" keys="${com.nala.csd.Hero.list()*.id}" value="${userId }" noSelection="['':'']" />--}%
                                    %{--</g:else>--}%
                                </td>
                            </tr>
                            <tr class="prop">
                        	...
                        	<tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: jinGuanShouHouInstance, field: 'solveType', 'errors')}">
                                    %{--<g:select class="origen" name="solveType" from="${com.nala.csd.SolveTypeEnum?.values()*.getDescription()}" keys="${com.nala.csd.SolveTypeEnum?.values()*.name()}" value="${jinGuanShouHouInstance?.solveType?.name() }" noSelection="['':'']"  />--}%
