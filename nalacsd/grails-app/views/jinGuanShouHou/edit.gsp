...
<html>
    <head>
        ...
        <title><g:message code="default.edit.label" args="['金冠店售后登记记录']" /></title>
    </head>
    <body>
        <div class="nav">
            <span class="menuButton"><a class="home" href="${createLink(uri: '/')}">首页</a></span>
            <span class="menuButton"><g:link class="list" action="list">金冠店售后记录列表</g:link></span>
        ...
        <div class="body">
            ...
            <form method="post" onsubmit="return testNull()">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: jinGuanShouHouInstance, field: 'solveCS', 'errors')}">
                                    <g:select name="solveCS.id" from="${com.nala.csd.Hero.findAllByAccountLocked(false)*.name}" keys="${com.nala.csd.Hero.findAllByAccountLocked(false)*.id}" value="${jinGuanShouHouInstance?.solveCS?.id}"  noSelection="['':'']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: jinGuanShouHouInstance, field: 'solveType', 'errors')}">
                                    <g:select class="origen" name="solveType" id="solveType" from="${com.nala.csd.JinTmallSolveType.list()?.name}" keys="${com.nala.csd.JinTmallSolveType.list()?.id}" value="${jinGuanShouHouInstance?.solveType?.id}" noSelection="['':'']" />
                                </td>
                            </tr>
