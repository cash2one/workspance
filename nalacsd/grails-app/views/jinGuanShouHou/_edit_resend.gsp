...
<tr class="resend" >
	...
	<td valign="top" class="value"><g:textField name="bufaWuliuNo" id="bufaWuliuNo"
...
<tr class="resend" >
	...
	<g:if test="${jinGuanShouHouInstance?.resend?.postageNum }"><td valign="top" class="value"><g:textField id="bufaPostageNumStr" name="bufaPostageNumStr" value="${jinGuanShouHouInstance?.resend?.postageNum/100 }" />(元)</td></g:if>
