    ...
    <body>
        ...
        <div class="body">
            ...
            <fieldset>
				...
				%{--处理方式 <g:select name="solveType" value="${params.solveType }" from="${com.nala.csd.SolveTypeEnum?.values()*.getDescription()}" keys="${com.nala.csd.SolveTypeEnum?.values()*.getCode()}" noSelection="['':'']"  />--}%
            ...
            <h1>金冠店售后记录列表 [数量: ${jinGuanShouHouInstanceTotal }] </h1>
