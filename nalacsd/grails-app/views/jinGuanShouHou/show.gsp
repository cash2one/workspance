...
<html>
    <head>
        ...
        <title><g:message code="default.show.label" args="['金冠店售后登记记录']" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <span class="button"><g:actionSubmit class="delete" action="delete" value="删除" onclick="return confirm('你确定吗?');" /></span>
                </g:form>
            </div>
        </div>
    </body>
