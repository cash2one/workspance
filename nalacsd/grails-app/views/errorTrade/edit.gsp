...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <g:if test="${tp}">
                <span class="menuButton"><g:link class="list" action="list"  params="[storeType:'true']"><g:message code="default.list.label" args="['TP店异常单记录列表']" /></g:link></span>
            </g:if>
            <g:else>
                <span class="menuButton"><g:link class="list" action="list"  params="[storeType:'false']"><g:message code="default.list.label" args="['异常单记录列表']" /></g:link></span>
            </g:else>
            <g:if test="${tp}">
                <span class="menuButton"><g:link class="create" action="create"  params="[storeType:'true']"><g:message code="default.new.label" args="['TP店异常单记录列表']" /></g:link></span>
            </g:if>
            <g:else>
                <span class="menuButton"><g:link class="create" action="create"  params="[storeType:'false']"><g:message code="default.new.label" args="['异常单记录列表']" /></g:link></span>
            </g:else>
        </div>
        <div class="body">
            <h1><g:message code="default.edit.label" args="['异常单']" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${errorTradeInstance?.version}" />
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="dealPriority"><g:message code="errorTrade.tradeId.label" default="处理优先级" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: errorTradeInstance, field: 'dealPriority', 'errors')}">
                                    <g:select name="dealPriority" from="${com.nala.csd.DealPriority.list().name}" keys="${com.nala.csd.DealPriority.list().id}" value="${errorTradeInstance?.dealPriority?.id}" noSelection="['': '']" />
                                </td>
                            </tr>
	                    	...
	                    	<tr class="prop">
	                            ...
	                            <td valign="top" class="value"><g:link controller="item" action="edit" id="${item.id}" params="[errorTradeId:errorTradeInstance.id]">${item.name}(编辑)</g:link></td>
	                        </tr>	                    	
	                        <tr class="prop">
	                            <td valign="top" class="name">----------</td>
	                            <td valign="top" class="value">---------------------------------------------------------------------</td>
	                    	...
	                    	<tr class="prop">
	                            ...
	                            <td valign="top" class="value"><g:link controller="item" action="create" params="[errorTradeId:errorTradeInstance.id]">点击新增商品</g:link></td>
	                        </tr>	                    	
	                        <tr class="prop">
	                            <td valign="top" class="name">----------</td>
	                            <td valign="top" class="value">---------------------------------------------------------------------</td>
