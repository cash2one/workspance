...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <g:if test="${tp}">
                <g:link class="list" action="list" params="[storeType:'true']"><g:message code="default.list.label" args="['TP店查件被动列表']" /></g:link></span>
            </g:if >
            <g:else>
                <g:link class="list" action="list" params="[storeType:'false']"><g:message code="default.list.label" args="['查件被动列表']" /></g:link></span>
            </g:else>
        </div>
        <div class="body">
            <h1><g:message code="default.create.label" args="['查件被动表记录']" /></h1>
                        ...
                        <tbody>
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: chajianPassiveInstance, field: 'createCS', 'errors')}">
                                    <g:select name="createCS.id" from="${com.nala.csd.Hero.list()*.name}" keys="${com.nala.csd.Hero.list()*.id}" value="${chajianPassiveInstance?.createCS?.id}" noSelection="['': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="chajianCode"><g:message code="chajianPassive.chajianCode.label" default="查件代码" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: chajianPassiveInstance, field: 'solveCS', 'errors')}">
                                    <g:select name="solveCS.id" from="${com.nala.csd.Hero.findAllByAccountLocked(false)*.name}" keys="${com.nala.csd.Hero.findAllByAccountLocked(false)*.id}" value="${chajianPassiveInstance?.solveCS?.id}" noSelection="['': '']" />
                                </td>
                            </tr>
