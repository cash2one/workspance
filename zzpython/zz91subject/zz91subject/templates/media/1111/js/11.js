...
$(function(){
	...
	countDown("2013/11/12 00:00:00","#demo01 .day","#demo01 .hour","#demo01 .minute","#demo01 .second");
...
function pop_up(obj){	
	...
	jIframe('/1111/img/', '行业热门推荐截图效果请点击','730','370');
...
function pop_up2(obj){	
	...
	jIframe('/1111/img2/', '地区至尊广告截图效果请点击','975','300');
...
function miaosha(obj){	
	...
	jIframe('/1111/miaosha/', '精品废料大黄页秒杀','600','320');
...
function bm(obj){	
	...
	jIframe('/1111/baoming/', '再生通会员团购报名','600','350');
...
function bm1(obj){	
	...
	jIframe('/1111/baoming1/', '再生通会员团购报名','600','350');
