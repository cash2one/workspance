...
if (!YAHOO.util.DragDropMgr) {
    ...
    YAHOO.util.DragDrop.prototype = {
        ...
        isValidHandleChild: function(g) {
            ...
            for (var d = 0,
            c = this.invalidHandleClasses.length; f && d < c; ++d) {
...
}; (function() { ["indexOf", "lastIndexOf", "forEach", "filter", "map", "some", "every", "copy"].forEach(function(a) {
        if (!Array[a]) {
            Array[a] = function(b) {
...
var TB = TB || {}; (function() {
    ...
    TB.Suggest.prototype = {
        ...
        _initTextInput: function() {
            ...
            b.on(this.textInput, "focus",
            function() {
                i.start()
            });
            b.on(this.textInput, "blur",
            function() {
                i.stop();
                i.hide()
            });
...
function() {
    ...
    this.decorate = function(container, config) {
        ...
        Event.on(container, "mouseover",
        function() {
            handle.suspend = true
        });
        Event.on(container, "mouseout",
        function() {
            handle.suspend = false
        });
    ...
    TB.widget.Slide.prototype = {
        init: function(f, g) {
            ...
            try {
                ...
                if (!this.slidesUL) {
                    this.slidesUL = c.getFirstChild(this.container,
                    function(i) {
        ...
        initSlides: function() {
            b.on(this.slides, "mouseover",
            function() {
                this.pause = true
            },
            this, true);
            b.on(this.slides, "mouseout",
            function() {
                this.pause = false
            },
            this, true);
