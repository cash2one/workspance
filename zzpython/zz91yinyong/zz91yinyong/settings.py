# Django settings for zz91yinyong project.
import os,sys
DEBUG = True
...
ALLOWED_HOSTS = ["pyapp.zz91.com","m.zz91.com","app.zjfriend.com","www.zz91.com"]
...
SECRET_KEY = 'w$vb*++wx6v9jr@1d^q^kjuj(40^j$gzpat_e1(huv8hed+v5_'
...
ROOT_URLCONF = 'zz91yinyong.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'zz91yinyong.wsgi.application'
