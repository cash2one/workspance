...
def addnewsok(request):
    ...
    if title and body:
        if artid:
            zzn.updatenews(title,shorttitle,pubdate,litpic,click,writer,typeid,typeid2,body,artid)
        else:
            zzn.addnews(title,shorttitle,litpic,click,writer,typeid,typeid2,body,pubdate)
