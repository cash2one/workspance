...
function send1()
{
document.form.action="dataout.html"
document.form.submit()
}
function send2()
{
document.form.action="analysischart.html"
document.form.submit()
}
function send3()
{
document.form.action="analyse_pageout.html"
document.form.submit()
}
function send4()
{
document.form.action="analyse_page.html"
document.form.submit()
}
function send7()
{
document.form.action="ipvisit.html"
document.form.submit()
}
function send8()
{
document.form.action="ipvisitout.html"
document.form.submit()
}

function QuickEdit(aid, e, obj)
{
	LoadQuickDiv(e, 'add_type.html', 'quickEdit', '450px', '300px');
	ChangeFullDiv('show');
}
