...
class zapp:
    ...
    def installuserlist(self,frompageCount,limitNum,account='',gmt_begin="",gmt_end="",open_type=""):
        ...
        for result in resultlist:
            ...
            appsystem=result[5]
            list={'id':id,'open_id':open_id,'open_type':open_type,'target_account':target_account,'closeflag':closeflag,'appsystem':appsystem,'gmt_created':gmt_created,'instrudycode':instrudycode}
            listall.append(list)
        return {'list':listall,'count':count}
    #app安装 图表统计
