...
class mainSource(object):
	...
	def Connected(self):   #如果是数据库，则在此处做数据库连接
		if self.conn==None:	   
			...
			sql = "SELECT  id,com_email,newemail,membertype,com_id,cname,comkeywords,js1,js2,sl1,sl2,province,cproductslist,ccontactp,ctel,cmobile,cadd,pcheck,huangye_qukan,qt1,qt2 FROM huangye_list where huangye_qukan='2015' and pcheck=1"
