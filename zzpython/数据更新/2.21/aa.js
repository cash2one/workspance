(function(a, b) {
    ...
    h.extend({
        ...
        later: function(q, v, r, u, t) {
            q = q || 0;
            var p = r,
            s, w;
            if (v && h.type(r) === "string") {
                p = v[r]
            }
            s = (u === c) ?
            function() {
                ...
                p.apply(v, h.makeArray(u))
            };
            w = (t) ? setInterval(s, q) : setTimeout(s, q);
            return {
                id: w,
                interval: t,
                cancel: function() {
        ...
        unparam: function(p, r) {
            ...
            function(t, v) {
                if ((v = v.split("="))[0]) {
                    var s = decodeURIComponent(v.shift()),
                    u = v.length > 1 ? v.join("=") : v[0];
                    if (u != c) {
        ...
        paramSpecial: function(o, q) {
            ...
            return p.join("&").replace(/\//g, "%2F").replace(/#/g, "%23").replace(/\+/g, "%2B").replace(/\s/g, "+")
        },
        methodize: function(t, p, s) {
            var q = {};
            for (var o in t) {
                if (s) {
                ...
                if (!s || s[r] != o) { (function(u) {
                        q[u] = function() {
                            var w = [].slice.call(arguments),
                            v = p ? this[p] : this;
                            return t[u].apply(t, [v].concat(w))
                        }
                    })(o)
                }
            }
        ...
        extendNative: function(q, v, s, u, p) {
            var w = [].slice,

            o = function(y, x) {
                if (x) {
                    return function() {
                        var z = w.call(arguments);
                        return y.apply(this[x], z)
                    }
                }
                return y
            };
            for (var r in v) {
                if (v.prototype[r]) {
                    q.prototype[r] = o(v.prototype[r], u)
                }
            }
            if (s) {
                for (var t = s.length; t--;) {
                    if (v.prototype[s[t]]) {
                        q.prototype[s[t]] = o(v.prototype[s[t]], u)
                    }
                }
            }
            if (p) {
                q.prototype.toString = p
            }
        },
        log: h.noop
    });
    h.namespace("jQuery.util.ua", "jQuery.ui");
    h.extendIf(h.util, {
        cookie: function(q, s, p) {
            ...
            return (o = new RegExp("(?:^|; )" + r(q) + "=([^;]*)").exec(document.cookie)) ? t(o[1]) : null
        },
        subCookie: function(p, q, o) {
            var r = h.unparam(h.util.cookie(m) || "", "|") || {},
            o = o || {
                path: "/",
                domain: "alibaba.com",
            ...
            if (arguments.length > 1) {
                r[p] = q;
                return h.util.cookie(m, h.param(r).replace(/&/g, "|"), o)
            } else {
                return r[p] === c ? null: r[p]
            }
        },
        substitute: function(p, o) {
            return p.replace(/\{(\w+)\}/g,
            function(s, q) {
                return o[q] !== c ? o[q] : "{" + q + "}"
            })
        },
        escapeHTML: function(p, o) {
            if (o) {
                return p.replace(/[<"']/g,
                function(r) {
                    switch (r) {
        ...
        unescapeHTML: function(o) {
            ...
            p.innerHTML = o.replace(/<\/?[^>]+>/gi, "");
            return p.childNodes[0] ? p.childNodes[0].nodeValue: ""
        }
    });
    h.extendIf(h.util.ua, {
        ie: !!h.browser.msie,
        ie6: !!(h.browser.msie && h.browser.version == 6),
        ie67: !!(h.browser.msie && h.browser.version < 8)
    });
    h.extendIf(h.support, {
    ...
    h.fn.extend({
        serializeSpecial: function() {
            return h.paramSpecial(this.serializeArray())
        }
    });
    function a(o) {
        return o.replace(/%/g, "%25").replace(/&/g, "%26")
    }
    function g(p, r, o, q) {
        if (d(r) && r.length) {
            j(r,
            function(t, s) {
                if (o || rbracket.test(p)) {
                    q(p, s)
                } else {
                    g(p + "[" + (typeof s === "object" || d(s) ? t: "") + "]", s, o, q)
                }
            })
        } else {
            if (!o && r !== null && typeof r === "object") {
                if (d(r) || h.isEmptyObject(r)) {
                    q(p, "")
                } else {
                    j(r,
                    function(t, s) {
    ...
    h.extendIf(Array.prototype, {
        every: function(r, q) {
            for (var p = 0,
            o = this.length; p < o; p++) {
                if (!r.call(q, this[p], p, this)) {
                    return false
                }
            }
            return true
    ...
    if (! ((0.009).toFixed(2) === "0.01" && (0.495).toFixed(2) === "0.50")) {
        var b = Number.prototype.toFixed;
    ...
    h.EventTarget = {};
    j(["bind", "trigger", "triggerHandler"],
    function() {
        var o = this;
        h.EventTarget[o] = function() {
            var p;
            p = this.__eventTargetProxy = this.__eventTargetProxy || h("<div>");
    ...
    e = {};
    h.extend({
        loadCSS: function(r, v, A) {
            var z = l.getElementsByTagName("head")[0] || l.documentElement,
            t = z.getElementsByTagName("base"),
            y = i[r],
            q;
            if (h.isFunction(v)) {
                A = v;
            ...
            if (y) {
                ...
                if (h.isPlainObject(v)) {
                    h.extend(u, v)
                }
                for (var s in u) {
                    y.setAttribute(s, u[s])
                }
                i[r] = y;
                A && x(y, A)
            }
            return t.length ? z.insertBefore(y, t[0]) : z.appendChild(y);
            function x(o, p) {
                if (o.attachEvent) {
        ...
        use: function(s, t, q) {
            ...
            s = (d(s) ? s: h.unique(s.replace(/\s+/g, "").split(",")));
            var r = 0;
            if (h.type(t) === "boolean" || h.type(t) === "object") {
                q = t;
                t = c
            }
            j(s,
            function(v, u) {
                ...
                if (w) {
                    if (q && w.url) {
                        ...
                        h.extend(w, q, {
                            status: w.callbackQueue ? "refresh": "reset"
                        })
                    }
                    if (w.status === "ready") {
                        o(w._data)
    ...
    function n(p, z, A) {
        ...
        s = x.js;
        if (r || d(s) || d(v)) {
            x.callbackQueue = x.callbackQueue || [];
            x.callbackQueue[x.callbackQueue.length] = z;
            if (x.callbackQueue.length === 1 || x.status === "refresh") {
                var w = 1,
                o = 0,
                y = function(q) {
                    o++;
                ...
                if (r) {
                    x.jqxhr && x.jqxhr.abort();
                    x.jqxhr = h.ajax(h.extendIf({
                        global: false,
                        success: y,
                        error: x.error || u,
                        complete: t
                    ...
                    j(v,
                    function(B, q) {
                        q = f.substitute(q, [h.styleDomain, x.ver]);
                        h.loadCSS(q, y)
                    });
                    j(s,
                    function(q, B) {
                        B = f.substitute(B, [h.styleDomain, x.ver]);
                        if (h.DEBUG) {
                            B = B.replace("-min", "")
                        }
                        h.ajax(B, {
...
(function(e) {
    ...
    function f(h) {
        return FE.test && FE.test[h]
    }
    e.namespace("FE.sys", "FE.util.jasmine", "FE.ui");
    var g = FE.util,
    d = e.util.cookie,
    b = e.support;
    g.LoginId = function() {
        var h = d("__cn_logon_id__", {
            raw: true
        });
    ...
    g.loginId = g.LoginId();
    g.IsLogin = function() {
        return (g.LoginId() ? true: false)
    };
    g.isLogin = g.IsLogin();
    g.LastLoginId = function() {
        var h = d("__last_loginid__", {
            raw: true
        });
        return h && decodeURIComponent(h)
    };
    g.lastLoginId = g.LastLoginId();
    g.getLastMemberId = function() {
        var h = d("last_mid", {
            raw: true
        });
        return h && decodeURIComponent(h)
    };
    g.updateLoginInfo = function(k) {
        k = e.extend({
            source: ["b2b", "taobao"]
        },
        k);
        ...
        l(j[m]);
        function l(o) {
            var n = g["updateLoginInfoFrom" + o.substr(0, 1).toUpperCase() + o.substr(1)];
            if (e.type(n) === "function") {
                e.when(n(i)).always(function() {
                    if (g.IsLogin()) {
                        i.resolve()
                    } else {
                        h()
    ...
    g.updateLoginInfoFromB2b = function() {
        var h = new e.Deferred;
        h.resolve();
        return h.promise()
    };
    g.updateLoginInfoFromTaobao = function() {
        var h = new e.Deferred;
        g.getLoginInfoFromTaobao().always(function(k) {
            var j = k.__cn_logon_id__,
            i = k.__last_memberid__;
            if (j) {
                ...
                function() {
                    ...
                    if (/\balibaba\.com$/.test(location.hostname)) {
                        l.domain = "alibaba.com";
                        l.path = "/"
                    } else {
                        if (/\b1688\.com$/.test(location.hostname)) {
                            l.domain = "1688.com";
                            l.path = "/"
                        }
                    }
                    e.util.cookie("__cn_logon_id__", j, l);
                    e.util.cookie("__last_loginid__", j, e.extend({
                        expires: 30
                    },
                    l));
                    e.util.cookie("__cn_logon__", true, l);
                    i && e.util.cookie("last_mid", encodeURIComponent(i), l);
                    g.loginId = j;
                    g.isLogin = true;
                    h.resolve(k)
                })
    ...
    g.getLoginInfoFromTaobao = function() {
        var h = f("style.logintaobao.sync.url") || "http://b2bsync.taobao.com/tbc";
        return e.ajax({
            url: h,
            dataType: "jsonp"
        }).promise()
    };
    g.isLoginIdAutoGen = function() {
        return /^b2b-.+/.test(g.LoginId())
    };
    g.goTo = function(i, l) {
        var k = "_self";
        l = l || k;
        if (!e.util.ua.ie) {
            return window.open(i, l)
        }
        var j = document.createElement("a"),
        h = document.body;
        j.setAttribute("href", i);
        j.setAttribute("target", l);
    ...
    if (!window.console) {
        window.console = {};
        console.log = console.info = e.log
    }
    e(function() {
        e.DEBUG = /debug=true/i.test(location.search);
        if (e.DEBUG) {
            e.use("util-debug")
        }
        e.JASMINE = /jasmine=true/i.test(location.search);
        if (e.JASMINE) {
            e.add("ext-jasmine-specs", {
                requires: ["ext-jasmine"],
                js: a.stack
            });
            e.use("ext-jasmine-specs",
            function() {
                e.use("ext-jasmine-html, ext-jasmine-jquery",
                function() {
                    a.Env = jasmine.getEnv();
                    var h = new jasmine.TrivialReporter();
                    a.Env.addReporter(h);
                    a.Env.specFilter = function(i) {
                        return h.specFilter(i)
                    };
                    c = true
                })
            })
...
(function(g) {
    ...
    a = "http://{0}/fdevlib/{t}/fdev-v4/widget/{p}-min.{t}?v={1}";
    for (var b in c) {
        var k = c[b],
        d = k.js,
        h = k.css,
    ...
    g.styleDomain = "style.c.aliimg.com"
})(jQuery);;
jQuery.namespace("Search.index.common"); ! (function(c) {
    var b = true;
    var a = false;
    c.extend(Search.index.common, {
        init: function() {
            var d = this;
            c(".j_t_favorite").click(function() {
                ...
                if (document.all) {
                    try {
                        ...
                        try {
                            ...
                            alert("\u60a8\u7684\u6d4f\u89c8\u5668\u6536\u85cf\u8be5\u9875\u9762\u6ca1\u6709\u6210\u529f\uff0c\u8bf7\u5c1d\u8bd5" + f + "+D\u8fdb\u884c\u6536\u85cf")
                        }
                    }
                } else {
                    if (window.sidebar) {
            ...
            d.auto_q(c("#j_q"));
            c("#j_q").focus(function() {
                d.auto_q_focus(c(this))
            });
            c("#j_q").blur(function() {
                d.auto_q(c(this))
            });
            d.j_t_bottom_ready();
            c("div#j_t_nav a").click(function() {
                d.j_t_bottom_change(c(this))
            })
        },
        auto_q: function(d) {
        ...
        j_t_bottom_ready: function() {
            var d = c("div#j_t_nav a:first");
            if (!d) {
                return
            }
            a_width = d.width();
            c("#j_t_bottom").css("width", a_width + 30);
            this.updateFormAction(d.prop("rel"))
        },
        j_t_bottom_change: function(f) {
            var d = this;
            a_left = f.offset().left;
            a_width = f.width();
            var e = c("#j_t_bottom");
            var g = e.offset().left;
            if (!a) {
                ...
                ((Math.abs(a_left - 10 - g) + 150) * 110) / 100,
                function() {
                    a = false;
                    d.updateFormAction(f.prop("rel"))
                })
            }
        },
        updateFormAction: function(e) {
            var d = c("form#j_search_form");
            if (e == "sale") {
                d.prop("action", "http://s.1688.com/selloffer/offer_search.htm")
            } else {
                if (e == "company") {
                    d.prop("action", "http://s.1688.com/company/company_search.htm")
                } else {
                    if (e == "map") {
                        d.prop("action", "http://ditu.1688.com")
                    } else {
                        if (e == "buy") {
                            d.prop("action", "http://s.1688.com/newbuyoffer/buyoffer_search.htm")
                        } else {
                            if (e == "news") {
                                d.prop("action", "http://s.1688.com/news/news_search.htm")
                            }
                        }
                    }
                }
...
jQuery.namespace("Search.index.searchtrace"); ! (function(a) {
    a.extend(Search.index.searchtrace, {
        bind: function() {
            var b = this;
            a("a").click(function() {
                var c = a(this).attr("searchtrace");
                if (c) {
                    b.aliclick("?searchtrace=" + c)
                }
            });
            a("#j_search_form").submit(function() {
                b.submit_trace()
            })
        },
        submit_trace: function() {
            var b = "?searchtrace=search_index_submit_";
            var c = a("#j_search_form").prop("action");
            if (c.match("selloffer")) {
                b += "sale"
            } else {
                if (c.match("company")) {
                    b += "company"
        ...
        aliclick: function(b) {
            if (typeof window.dmtrack != "undefined") {
                setTimeout(function() {
                    dmtrack.clickstat("http://stat.1688.com/search/queryreport.html", b)
                },
                10)
            } else {
                if (document.images) { (new Image()).src = "http://stat.1688.com/search/queryreport.html" + b + "&time=" + ( + new Date)
                }
            }
        }
    })
})(jQuery);;
jQuery.namespace("Search.index.suggest"); ! (function(e) {
    var b;
    var c;
    var f;
    var a = false;
    var d = true;
    e.extend(Search.index.suggest, {
        bind: function() {
            var g = this;
            e("#j_q").keyup(function(h) {
                if (h.keyCode != "38" && h.keyCode != "40" && h.keyCode != "27") {
                    g.suggestion(e(this))
                }
            });
            e(document).mouseup(function() {
                if (document.activeElement.id == "j_q") {
                    g.suggestion(e("#j_q"))
                } else {
                    e("#index_suggest").css("display", "none");
                    setTimeout(function() {
                        a = false
                    },
                    10)
            ...
            e("#index_suggest").delegate("li", "mouseenter",
            function() {
                if (!a) {
                    return
                }
                c = e(this).attr("index");
                g.changeSuggestHover(e(this))
            });
            e("#index_suggest").delegate("li", "click",
            function() {
                if (!a) {
                    return
                }
                e("#j_q").val(e(this).attr("key"));
                e("#j_search_form").submit()
            });
            e(document).keydown(function(h) {
                if (!a || !f || f.length == 0) {
                    return
                }
                if (d) {
        ...
        suggest_keydown: function(g) {
            if (g.keyCode == "38") {
                ...
                e("#j_q").val(e(f[c]).attr("key"));
                this.changeSuggestHover(e(f[c]))
            } else {
                if (g.keyCode == "40") {
                    if (c >= f.length - 1) {
                        c = 0
        ...
        get_suggest: function(i) {
            var g = this;
            suggest_query = "http://suggest.1688.com/bin/suggest?q=" + i + "&type=";
            var h = e("#j_search_form").prop("action");
            if (h.match("selloffer") || h.match("buyoffer")) {
                suggest_query += "saleoffer"
            } else {
                if (h.match("company") || h.match("ditu")) {
                    suggest_query += "company"
                } else {
                    return
                }
            }
            e.ajax({
                ...
                dataType: "script",
                success: function() {
                    var j = g.format_data(_suggest_result_);
                    g.buildSuggest(j)
                }
            })
        },
        format_data: function(m) {
            var h = [];
            if (!m) {
                return h
            }
            if (e.isArray(m.result)) {
                m = m.result
            }
            var g = m.length;
            if (!g) {
        ...
        buildSuggest: function(g) {
            e.use("web-sweet",
            function() {
                var i = '<ol><% for ( var i = 0; i < $data.length; i++ ) { %>						<li key="<%= $data[i].title %>" title="<%= $data[i].title %>" index="<%= i %>">							<span class="suggest-key"><%= $data[i].key %></span>							<span class="suggest-result">\u7ea6<%= $data[i].result %>\u6761\u7ed3\u679c</span>						</li>					<% } %>	</ol>';
                var h = FE.util.sweet(i).applyData(g);
                if (g && g.length > 0) {
                    e("#index_suggest").html(h);
                    e("#index_suggest").css("display", "block");
                    a = true
                } else {
                    e("#index_suggest").css("display", "none")
                }
                f = e("#index_suggest ol li");
                c = -1;
                b = null
            })
        },
        changeSuggestHover: function(g) {
            if (b) {
                b.removeAttr("class")
            }
            g.addClass("selected");
