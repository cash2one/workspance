...
sql = "select id,mobile,gmt_created,stat_id,company_id,flag from sms_log where id>"+getlastid(updatetablename)+" and DATEDIFF(CURDATE(),gmt_created)<=5 order by id asc"
#print sql
cursor_mysql_sms.execute(sql)
