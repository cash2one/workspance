#-*- coding:utf-8 -*-
from public import *
from zz91tools import getToday,date_to_str,get_url_content,get_content,get_inner_a,get_a_url,remove_content_a,remove_content_div,filter_tags
