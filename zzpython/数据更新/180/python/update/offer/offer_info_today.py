...
updatetablename="offer_info_today"
...
if (maxupid==''):
	maxupid='0'
#convert(bigint,gmt_editdate)>'"+maxupdate+"' and
...
sql +=" from products where pdt_time_en>=dateadd(d,-10,getdate()) and pdt_id>"+getlastid(updatetablename)+" order by pdt_id asc"
cursor1.execute(sql)
results = cursor1.fetchmany(8000)
