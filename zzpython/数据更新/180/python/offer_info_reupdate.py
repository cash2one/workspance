...
sql = "select com_id,0,pdt_id,pdt_kind,pdt_name,pdt_com_province,pdt_detail,pdt_time_en,pdt_check,pdt_keywords,convert(bigint,gmt_editdate)"
sql +=" from products where exists(select pdt_id from products_notShowPrice where pdt_id=products.pdt_id) order by gmt_editdate asc"
cursor1.execute(sql)
