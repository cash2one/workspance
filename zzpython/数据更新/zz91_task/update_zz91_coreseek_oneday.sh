/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf company_price --rotate
/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf pricelist --rotate
/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf news --rotate
/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf price_data --rotate
/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf newstags --rotate
/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf price --rotate

/usr/local/coreseek/bin/indexer --config /mnt/coreseek/etc/mysql_index2.conf sex --rotate
