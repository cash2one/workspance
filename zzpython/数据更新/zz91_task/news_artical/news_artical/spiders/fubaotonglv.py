...
from news_artical.items import fubaotonglv
import sys
reload(sys)
...
class dmozSpider(CrawlSpider):
    ...
    start_urls=["http://news.f139.com/list.do?channelID=9&categoryID=24&isMain=false",]
    ...
    def into(self,url,pubdate):
        ...
        if res_all:
            ...
            pattern_artical=re.compile(r'<div class="text f14" id="zhengwen">(.*?)<div class="blank12">',re.S)
