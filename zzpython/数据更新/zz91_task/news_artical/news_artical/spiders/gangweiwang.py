...
from news_artical.items import gangwei
import sys
reload(sys)
...
class dmozSpider(CrawlSpider):
    ...
    start_urls=["http://news.prcsteel.com/view/Analysts.aspx",]
    ...
    def into(self,url,pubdate):
        ...
        title=''
        artical=''
        pattern_all=re.compile(r'<div class="detail_con">(.*?)<div class="except">',re.S)
        ...
        if res_all:
            ...
            if res_title:
                ...
                #print title
            #匹配文章    
            pattern_artical=re.compile(r'<article>(.*?)</article>',re.S)
    ...
    def parse(self, response):
        ...
        #current_date='2015-08-18'
        pubdatelist=sel.xpath("//*[@class='levtwo_imglist_con']/div/label/text()").extract()
        titllist=sel.xpath("//*[@class='levtwo_imglist_con']/div/h2/a/@href").extract()
        ...
        for pubdate in pubdatelist:
            ...
            if pubdate>=current_date:
                ...
                titleurl='http://news.prcsteel.com/view/'+titleurl
                print a
                print 'ook' 
                print pubdate
                print titleurl
