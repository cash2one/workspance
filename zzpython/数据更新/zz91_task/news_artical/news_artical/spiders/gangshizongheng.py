...
from news_artical.items import zongheng
import sys
reload(sys)
...
class dmozSpider(CrawlSpider):
    ...
    start_urls=["http://news.steelcn.cn/zongheng.html",]
    ...
    def into(self,url):
        ...
        if res_all:
            ...
            pattern_artical=re.compile(r'<div class="art_main">(.*?)<div style="margin: auto;">',re.S)
