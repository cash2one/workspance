# Django settings for zz91cp project.
import os,sys
DEBUG = False
...
SECRET_KEY = '-_nmbox&k%++h!$fxyqyrc#u&sncck7r%o%%uoqrn+thz(f*vp'
...
ROOT_URLCONF = 'zz91cp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'zz91cp.wsgi.application'
