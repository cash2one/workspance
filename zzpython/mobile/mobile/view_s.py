...
def default(request):
	return HttpResponsePermanentRedirect("http://m.zz91.com")
...
def reg(request):
	...
	username=request.session.get("username",None)
	return HttpResponsePermanentRedirect("http://m.zz91.com/register/")
...
def login(request):
	...
	return HttpResponsePermanentRedirect("http://m.zz91.com/login/?done="+done)
	username=request.session.get("username",None)
	company_id=request.session.get("company_id",None)
...
def priceviews(request):
	...
	return HttpResponsePermanentRedirect("http://m.zz91.com/priceviews/?id="+done)
	username=request.session.get("username",None)
...
def huzhuviews(request,id):
	...
	suc=request.GET.get("suc")
	err=request.GET.get("err")
	return HttpResponsePermanentRedirect("http://m.zz91.com/huzhuview/"+str(id)+".htm")
	username=request.session.get("username",None)
...
def priceindex(request):
	...
	return HttpResponsePermanentRedirect("http://m.zz91.com/priceindex/")
...
def price(request):
	...
	return HttpResponsePermanentRedirect("http://m.zz91.com/price/?category_id="+str(category_id)+"&keywords="+str(keywords))
...
def huzhu(request):
	...
	category_id=request.GET.get("category_id")
	keywords=request.GET.get("keywords")
	return HttpResponsePermanentRedirect("http://m.zz91.com/huzhu/?category_id="+str(category_id)+"&keywords="+str(keywords))
	if (str(keywords)=='None'):	
		keywords=None
	if (str(category_id)=='None'):
		category_id=None
...
def productdetail(request):
	...
	pdtid=request.GET.get("pdtid")
	return HttpResponsePermanentRedirect("http://m.zz91.com/detail/?id="+str(pdtid))
...
def companyinfo(request):
	...
	company_id=request.GET.get("company_id")
	membercheck=request.session.get("membercheck",None)
	return HttpResponsePermanentRedirect("http://m.zz91.com/companyinfo/?company_id="+str(company_id))
	pdtid=request.GET.get("pdtid")
