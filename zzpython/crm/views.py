        ...
        if res.has_key('matches'):
            ...
            for match in tagslist:
                ...
                if (arrkname):
                    ...
                    list={'vap':vap,'trcolor':trcolor,'lastlogintime2':lastlogintime2,'com_id':com_id,'com_rank':com_rank,'com_name':com_name,'com_province':com_province,'com_email':com_email,'com_tel':com_tel,'com_mobile':com_mobile,'com_regtime':com_regtime,'lastlogintime':lastlogintime,'logincount':logincount,'teldate':teldate,'fdate':fdate,'com_contactperson':com_contactperson,'com_desi':com_desi,'realname':realnametxt,'zst':zst,'havevip':havevip}
                    listall.append(list)
