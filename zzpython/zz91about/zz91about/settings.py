# Django settings for zz91about project.
import os,sys
DEBUG = False
...
SECRET_KEY = '1vt^4^gsu$*e5r*)51x=4)jepn26ihxgo@vw(=bu7oizcmugt6'
...
WSGI_APPLICATION = 'zz91about.wsgi.application'
