# Django settings for zz91seoweb project.
import os,sys
DEBUG = True
...
SECRET_KEY = 'ahz3m65scrmi(=^a0tsr9p!h*g%65*oqg(8k#mbtzu=i!1beb6'
...
ROOT_URLCONF = 'zz91seoweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'zz91seoweb.wsgi.application'
