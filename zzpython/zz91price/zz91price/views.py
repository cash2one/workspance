...
import MySQLdb,os,datetime,time,sys,calendar,urllib
try:
...
def pindex(request,pinyin=""):
    if (pinyin=="suliao"):
        ...
        seodescription="ZZ91再生网旗下废塑料,为您提供各地区ABS价格,EVA价格,PA价格,PP价格,PS价格,PE价格,PVC价格,PC价格,PET价格,塑料颗粒价格等废塑料价格、市场动态、行情资讯、供应、求购信息,是废塑料商人销售产品、拓展市场及网络推广的首选网站。"
    if (pinyin=="jinshu"):
        labelname="废金属"
        labelname1="废金属日评"
        ...
        seodescription="ZZ91再生网旗下废金属,为您提供各地区废钢价格、废铁价格、废铜价格、废铝价格等废金属价格、市场动态、行情资讯、供应、求购信息,是废金属商人销售产品、拓展市场及网络推广的首选网站。"
    if (pinyin=="other"):
        labelname="综合废料"
        labelname1="油价"
...
#                pricelist=zzcomp.getprice_list(frompageCount=0,limitNum=30,maxcount=30,listfiled=listfield,priceid=int(id))
        ...
        keywords=''
        description='zz91再生网'+categoryname+'行情报价中心，为您提供'+title+'，信息准确可靠，让您及时掌握一手'+assistname+categoryname+'价格信息，熟悉最新'+assistname+categoryname+'市场动态。'
...
#    return render_to_response('main/index1.html',locals())
    ...
    description='ZZ91再生网报价资讯中心每天为您提供最新的废金属价格、废塑料价格行情、废纸价格、废橡胶价格等主流废料价格，实时更新，快速获取，安心做生意，放心有保障。'
    #----4个期货数据
...
#    ouzhou_suliao=zzcomp.getprlist(0,7,7,'',[63])['list']
    ouzhou_suliao=zzcomp.getpricedblist(0,7,63)['list']
    #----美国废塑料
#    meiguo_suliao=zzcomp.getprlist(0,7,7,'',[62])['list']
    meiguo_suliao=zzcomp.getpricedblist(0,7,62)['list']
    #----塑料再生料
    ...
    if result2:
        ...
        if pricelist:
            ...
            if maintypename=='废塑料':
                ...
                description='zz91再生网'+area+label+'行情报价中心，为您提供最新的'+area+label+'价格走势，让您能够快速知悉'+label+'最新市场动态，了解'+area+label+'最新价格走势就上zz91再生网。'
...
#    price1=request.GET.get('price1')
    ...
    if code=='10001000':
        ...
        description='zz91再生网'+province+city+'废塑料企业报价频道，每天准时为您精选各地厂家提供的关于各种'+province+city+'废塑料的价格，了解最新'+province+city+'废塑料出厂价，就上zz91再生网。'
        ...
        description='zz91再生网'+sslabel+' 废塑料企业报价频道，每天准时为您精选各地厂家提供的关于各种'+sslabel+'废塑料的价格，了解最新'+sslabel+'再生颗粒价格，就上zz91再生网。'
    elif code=='10001001':
        title=province+city+'塑料颗粒企业报价_'+province+city+'塑料颗粒价格行情_行情报价中心_第'+str(page)+'页-zz91再生网'
        keywords=province+city+'塑料颗粒企业报价，塑料颗粒价格'
        description='zz91再生网'+province+city+'废塑料企业报价频道，每天准时为您精选各地厂家提供的关于各种'+province+city+'塑料颗粒的价格，了解最新'+province+city+'塑料颗粒企业报价，就上zz91再生网。'
    elif code[:8]=='10001001':
        title=sslabel+'企业报价_'+sslabel+'价格行情_行情报价中心_第'+str(page)+'页-zz91再生网'
        keywords=sslabel+'企业报价，'+sslabel+'价格'
        description='zz91再生网'+sslabel+'企业报价频道，每天准时为您精选各地厂家提供的关于各种'+sslabel+'的价格，了解最新'+sslabel+'企业报价，就上zz91再生网。'
        ...
        description='zz91再生网'+sslabel+'企业报价频道，每天准时为您精选各地厂家提供的关于各种'+sslabel+'的价格，了解最新'+sslabel+'工厂价格，就上zz91再生网。'
