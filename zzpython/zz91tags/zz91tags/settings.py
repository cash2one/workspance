# Django settings for zz91tags project.
...
ALLOWED_HOSTS = ["tags.zz91.com","www.zz91.com"]
MANAGERS = ADMINS
...
SECRET_KEY = '@s_+*5l4xo&amp;%+3%xt4j-b!)o^6mgp28gdi=r-&amp;nc33%ee6h7)9'
...
ROOT_URLCONF = 'zz91tags.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'zz91tags.wsgi.application'
