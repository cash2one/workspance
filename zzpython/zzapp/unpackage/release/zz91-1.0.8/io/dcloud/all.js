...
plus.console.time = function() {}, plus.console.timeEnd = function() {}), function(a) {
    ...
    e.BUSY = 1, f = a.gallery = {
        ...
        pick:function(a, g, h) {
            ...
            var i = b.callbackId(function(b) {
                "function" == typeof a && a(b), f.__galleryStatus = d.Ready;
            }, function(a) {
                "function" == typeof g && g(new e(a)), f.__galleryStatus = d.Ready;
            });
            b.exec(c, "pick", [ i, h ]);
        },
        save:function(a, d, e) {
    ...
    e.prototype.fire = function() {
        ...
        b.onCompleted(b, a.status || null)), c = this.eventHandlers["statechanged"], c && c.fire(b, a.status || null);
    }, a.uploader = {
        __taskList__:{},
    ...
    d.process = function(a) {
        ...
        var d, f, c = null;
        return a ? "object" == a.type ? (d = e.isImport(a.className), d ? c = new d() :(c = new h(), 
    ...
    function n(e, g, h) {
        if (e && "string" == typeof e) {
            ...
            b.exec(c, d, [ c, "setcallbackid", [ k.__uuid__, [ k.__callback_id__ ] ] ]), f[e] = k), 
            k;
        }
    }
    function o(g) {
    ...
    a.bridge, a.tools, a.webview = {
        ...
        __Webview_LoadEvent_CallBack_:v
    };
}(window.plus), function(a) {
    function c(a) {
        this.__IDENTITY__ = a, this.__uuid__ = window.plus.tools.UUID(a), this.id, plus.obj.Callback.call(this);
    ...
    function g(c, d, e, f) {
        ...
        e || (a.__pushWindow__(this), a.exec(this, b, [ c, d, this.__callback_id__, window.location.href, f ]));
    }
    ...
    plus.tools.extend(h, a.NView.prototype), h.constructor = g, h.show = function(b, c, d) {
        ...
        for (d = 0; d < c.length; d++) b.push(plus.webview._find__Window_By_UUID__(c[d].uuid, c[d].id, c.extras));
        return b;
    }, h.getURL = function() {
        return a.execSync(this, "getUrl", []);
    }, h.getTitle = function() {
