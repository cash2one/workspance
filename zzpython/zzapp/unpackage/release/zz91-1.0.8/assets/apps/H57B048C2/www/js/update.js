(function(w) {
	var server = "http://app.zz91.com/js/update.json?t="+Math.ceil(new Date/3600000), //获取升级描述文件服务器地址
		localDir = "",
		localFile = "update.json", //本地保存升级描述目录和文件名
		keyUpdate = "updateCheck", //取消升级键名
		keyAbort = "updateAbort", //忽略版本键名
		checkInterval = 86400, //升级检查间隔，单位为ms,7天为7*24*60*60*1000=60480000, 如果每次启动需要检查设置值为0
		//checkInterval = 0,
		dir = null;
