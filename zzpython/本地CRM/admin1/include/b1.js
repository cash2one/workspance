...
function lik(id,n)
{
	if(confirm('保存信息吗?'))
	{
		...
		if(n==1)
		{
		form1.lianjie.value="admin_dz_public.asp"
		}
		if(n==2)
		{
		form1.lianjie.value="admin_dz_p1.asp"
		
		}
		if(n==3)
		{
		form1.lianjie.value="admin_dz_p2.asp"
		
		}
		if(n==4)
		{
		form1.lianjie.value="admin_dz_p3.asp"
		}
		if(n==5)
		{
		form1.lianjie.value="admin_dz_p4.asp"
		}
		if(n==6)
		{
		form1.lianjie.value="admin_dz_p5.asp"
		}
		if(n==7)
		{
		form1.lianjie.value="admin_dz_p6.asp"
		}
		form1.submit()
	}
	else
	{
	     if(n==1)
		{
	     window.location="admin_dz_public.asp?dz_code="+id
		}
		 if(n==2)
		{
	     window.location="admin_dz_p1.asp?dz_code="+id
		}
		 if(n==3)
		{
	     window.location="admin_dz_p2.asp?dz_code="+id
		}
		 if(n==4)
		{
	     window.location="admin_dz_p3.asp?dz_code="+id
		}
		 if(n==5)
		{
	     window.location="admin_dz_p4.asp?dz_code="+id
		}
		if(n==6)
		{
	     window.location="admin_dz_p5.asp?dz_code="+id
		}
		if(n==7)
		{
	     window.location="admin_dz_p6.asp?dz_code="+id
		}
	}
}
function lik1(id,n)
