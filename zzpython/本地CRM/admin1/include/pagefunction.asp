...
Class clsPageRs2
  ...
  Public Function getTotalPage
	...
	cmdcout.activeconnection=fConn 
	...
	cmdcout.Parameters.Append cmdcout.CreateParameter("@sql",adVarChar,adParamInput,4000," "&fFromTbl&" "&fSqlWhere)
  ...
  Public Function pageRs
	...
	cmd.Parameters.Append cmd.CreateParameter("@Filter",adVarChar,adParamInput,4000,fSqlWhere)
	cmd.Parameters.Append cmd.CreateParameter("@oKey",adVarChar,adParamInput,4000,fSqlOrder)
	...
	cmd.Parameters.Append cmd.CreateParameter("@outsql",adVarChar,adParamOutput,4000)
  ...
  Public Function pageRsid
	...
	cmd.Parameters.Append cmd.CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 4) 
	cmd.parameters.append cmd.createparameter("@qCols",adVarChar,AdParamInput,4000,sltFld) 
	cmd.parameters.append cmd.createparameter("@qTables",adVarChar,adParamInput,300,fFromTbl) 
	cmd.Parameters.Append cmd.CreateParameter("@iKey",adVarChar,adParamInput,20,keyFld)
	cmd.Parameters.Append cmd.CreateParameter("@Filter",adVarChar,adParamInput,4000,fSqlWhere)
	cmd.Parameters.Append cmd.CreateParameter("@oKey",adVarChar,adParamInput,4000,fSqlOrder)
	cmd.Parameters.Append cmd.CreateParameter("@pageSize",adInteger,adParamInput,,fPageSize)
