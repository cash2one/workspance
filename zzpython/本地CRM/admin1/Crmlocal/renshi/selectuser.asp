...
<form id="form2" name="form2" method="get" action="selectuser.asp">
  <tr>
    <td><select name="userid" class="button" id="userid" >
...
{
	var pobj=parent.document.getElementById("realname");
	var tobj=parent.document.getElementById("personid");
