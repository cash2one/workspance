...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><br>
      ...
      <tr>
        <td width="130" height="23" nowrap background="/admin1/newimages/shale_fill_1.gif"><img src="/admin1/newimages/shale_arrowhead.gif" width="28" height="23" align="absmiddle">人事基础数据管理</td>
