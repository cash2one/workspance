          ...
          <tr>
            <td bgcolor="#F1F3ED"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <form action="companyshow.asp" method="post" name="company_sec" id="company_sec" onSubmit="return subchk(this)">
                <tr>
                  <td align="right" bgcolor="#FFFFFF">店铺网址</td>
                  <td bgcolor="#FFFFFF"><a href="<%=weburl%>" target="_blank"><%=weburl%></a>
                    <input name="cid" type="hidden" id="cid" value="<%=cid%>">
                    <input name="edit" type="hidden" id="edit" value="1">
                    <input name="ghflag" type="hidden" id="ghflag" value="<%=gh%>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="right" bgcolor="#FFFFFF">店铺名</td>
                  <td bgcolor="#FFFFFF"><%=shop_name%> </td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#FFFFFF">旺旺号</td>
                  <td bgcolor="#FFFFFF"><%=wangwang_no%>
                    </td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#FFFFFF">行业分类</td>
