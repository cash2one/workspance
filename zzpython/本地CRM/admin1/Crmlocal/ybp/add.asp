...
if request.Form("edit")="1" then
	...
	rs("wangwang_no")=request.Form("wangwang_no")
	rs("hy_type")=request.Form("hy_type")
	rs("income")=request.Form("income")
              ...
              <form action="add.asp" method="post" name="company_sec" id="company_sec" onSubmit="return subchk(this)">
                <tr>
                  ...
                  <td bgcolor="#FFFFFF">
                    ...
                    <input type="text" name="weburl" id="weburl" class="text"></td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#FFFFFF"><span class="title">*</span> 地区</td>
                  <td bgcolor="#FFFFFF"><%=area%> <input type="text" name="area" id="area" class="text"></td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#FFFFFF"><span class="title">*</span>店铺名</td>
                ...
                <tr>
                  <td align="right" bgcolor="#FFFFFF"><span class="title">*</span>行业分类</td>
                  <td bgcolor="#FFFFFF"><%=hy_type%>
                    <input type="text" name="hy_type" id="hy_type" class="text"></td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#FFFFFF">销售额/元</td>
                  <td bgcolor="#FFFFFF"><%=income%>
                    <input name="income" type="text" class="text" id="income" onKeyUp="value=value.replace(/[^\d]/,'')" value="0"></td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#FFFFFF"><span class="title">*</span>联系方式</td>
