							...
							<tr height="18">
								...
								<td align="right" width="18">
									<table cellspacing="1" cellpadding="0" border="0" width="18" height="18" class="popupButton" onmouseover="this.className='popupButtonHover';" onmouseout="this.className='popupButton';" onmousedown="var img=this.rows[0].cells[0].children[0];img.src=img.src.replace('_black','_white');" onmouseup="var img=this.rows[0].cells[0].children[0];img.src=img.src.replace('_white','_black');" id="popupWin_MenuButton">
										<tr>
											<td align="center"><img src="images/popup_icon_arrow_black.gif" border="0" alt="" /></td>
										</tr>
									</table>
								</td>
								<td align="right" width="18">
...
<div class="popupMenu" id="popupWin_Menu">
	<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%" class="popupMenuTable">
		...
		<tr height="22">
			<td class="popupMenuRow" onmouseover="this.className='popupMenuRowHover';" onmouseout="this.className='popupMenuRow';" id="popupWin_Menu_Setting" URL="/User/EditProfile.aspx?ReturnUrl=/driver.aspx">
				<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
					<tr>
						<td width="28">&nbsp;</td>
...
p.PostID = 1;
p = popupManager.AddPopup("popupWin", "New Post Content1", "images/popup_icon_Post.gif", "New Post Subject1", func);
p.PostID = 2;
p = popupManager.AddPopup("popupWin", "New Post Content2", "images/popup_icon_Post.gif", "New Post Subject2", func);
p.PostID = 3;
