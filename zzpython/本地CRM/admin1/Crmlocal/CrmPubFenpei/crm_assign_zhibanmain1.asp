...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="30" align="center" bgcolor="#FFFFCC"><strong>星期日值班人员客户分配</strong></td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center"><IFRAME border=0 frameBorder=0 frameSpacing=0 noResize  src="crm_assign_zhibanfenpai1.asp" width="100%" height="400px" name="fenpei" id="fenpei"></Iframe></td>
  </tr>
