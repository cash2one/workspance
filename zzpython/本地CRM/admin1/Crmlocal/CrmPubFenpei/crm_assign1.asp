...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <form name="form1" id="form1" method="post" action="qf_mail_save.asp" target="sendmail">
    <tr>
      ...
      <input name="hou" type="text" id="hou" value="4" size="5">
      时
  ...
  <tr>
    <td align="center"><IFRAME border=0 frameBorder=0 frameSpacing=0 noResize  src="crm_assign_pubsales1.asp" width="100%" height="400px" name="fenpei" id="fenpei"></Iframe></td>
  </tr>
