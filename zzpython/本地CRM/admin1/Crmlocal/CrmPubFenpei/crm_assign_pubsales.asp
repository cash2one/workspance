...
%>
  <tr>
	...
	function fenp(frm)
	{
      ...
      <input type="button" class=button name="Submit" value="设置分配倾斜" onClick="fenp(this.form)">
...
%>
    <tr>
      <td align="center" bgcolor="#F2F2F2">
        ...
        <input type="button" class=button name="Submit" value="设置公海分配人员" onClick="fenp(this.form)">
