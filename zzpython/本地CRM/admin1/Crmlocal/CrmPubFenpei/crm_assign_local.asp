...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center"><IFRAME border=0 frameBorder=0 frameSpacing=0 noResize  src="crm_assign_pubsales_local.asp" width="100%" height="100px" name="fenpei" id="fenpei"></Iframe></td>
  </tr>
