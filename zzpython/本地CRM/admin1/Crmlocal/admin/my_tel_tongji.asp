...
<table width="1000" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#000000">
  <tr>
    <td colspan="12" align="center" bgcolor="#CCCCCC">联系情况统计</td>
  </tr>
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF">SEO销售</td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#F2F2F2"><IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=&contacttype=&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>&seoflag=1"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME></td>
