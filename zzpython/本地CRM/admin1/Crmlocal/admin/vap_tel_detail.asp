...
if seoflag<>"" then
	sqla=sqla&" and exists(select com_id from crm_seotel where v_salescomp.com_id=com_id)"
end if

sqla=sqla&" and com_id in (select com_id from comp_tel where telflag=4"
...
'---------------所有客户
sql1="select count(0) from v_salescomp where vpersonid="&personid&""
sql=sql1&" "&sqla&""
set rs=conn.execute(sql)
allcount=rs(0)
...
<table border="0" cellspacing="1" cellpadding="5" bgcolor="#666666">
  <tr>
    <td colspan="6" bgcolor="#f2f2f2" style="font-weight:bold">电话联系量统计</td>
  </tr>
  <tr>
    <td colspan="6" bgcolor="#FFFFFF" style="font-weight:bold">销售：<%=realname%> 客户星级：<%=request.QueryString("star")%></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">所有</td>
    <td colspan="5" bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=" target="_blank"><%=allcount%></a></td>
  </tr>
  <tr>
    <td width="80" bgcolor="#FFFFFF">大广告</td>
    <td colspan="5" bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_dakehu" target=_blank><%=dakehucount%></a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="80" bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_bisha" target=_blank><%=bishaqi%></a></td>
    <td width="80" bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_bisha&action=huangzhan" target=_blank><%=bishaqi1%></a></td>
    <td width="80" bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_bisha&action=biaowang" target=_blank><%=bishaqi2%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_bisha&action=dujia" target=_blank><%=bishaqi3%></a></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">黄金客户</td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_huangjin" target=_blank><%=huangjin%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_huangjin&action=huangzhan" target=_blank><%=huangjin1%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_huangjin&action=biaowang" target=_blank><%=huangjin2%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_huangjin&action=dujia" target=_blank><%=huangjin3%></a></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">新客户</td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_newcomp" target=_blank><%=newcustomer%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_newcomp&action=huangzhan" target=_blank><%=newcustomer1%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_newcomp&action=biaowang" target=_blank><%=newcustomer2%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_newcomp&action=dujia" target=_blank><%=newcustomer3%></a></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">过期客户</td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_guoqi" target=_blank><%=guoqicomp%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_guoqi&action=huangzhan" target=_blank><%=guoqicomp1%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_guoqi&action=biaowang" target=_blank><%=guoqicomp2%></a></td>
    <td bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_guoqi&action=dujia" target=_blank><%=guoqicomp3%></a></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">小广告</td>
    <td colspan="5" bgcolor="#FFFFFF"><a href="admin_tel_comp1.asp?<%=frompagequrstr%>&lmaction=ad_xiaoguangao" target=_blank><%=xiaoguanggaocount%></a></td>
  </tr>
</table>
</body>
</html>
