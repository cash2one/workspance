...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#000000">
  <tr>
    <td colspan="20" align="center" bgcolor="#CCCCCC">联系情况统计</td>
  </tr>
  <tr>
    ...
    <td colspan="2" align="center" bgcolor="#FFFFFF">SEO销售</td>
  ...
  %>
  <tr>
    <td colspan="20" bgcolor="#f2f2f2"><%=rs("meno")%></td>
  </tr>
  <%
  sql1="select realname,id from users where userid="&rs("code")&" and closeflag=1 and id<>227"
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF">
	<IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=5&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME>	</td>
    ...
    <td align="center" bgcolor="#FFFFFF">
    <IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=4.8&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME></td>
    <td align="center" bgcolor="#FFFFFF">
    ...
    <td align="center" bgcolor="#F2F2F2">
    <IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=4.1&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME></td>
    <td align="center" bgcolor="#F2F2F2">
    ...
    <td align="center" bgcolor="#FFFFFF">
	<IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=3&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME>	</td>
    <td align="center" bgcolor="#F2F2F2">
    ...
    <td align="center" bgcolor="#FFFFFF">
	<IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=2&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME>	</td>
    <td align="center" bgcolor="#F2F2F2">
    ...
    <td align="center" bgcolor="#FFFFFF">
	<IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=1&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME>	</td>
    <td align="center" bgcolor="#F2F2F2">
    ...
    <td align="center" bgcolor="#F2F2F2"><IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>&seoflag=1"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME></td>
    <td align="center" bgcolor="#F2F2F2"><IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&star=&contacttype=13&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>&seoflag=1"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME></td>
    ...
    <IFRAME border=0 name=aaaa  marginWidth=0 frameSpacing=0 marginHeight=0 src="TJ_1.asp?personid=<%=rs1("id")%>&contacttype=12&fromdate=<%=fromdate%>&todate=<%=todate%>&dotype=<%=dotype%>"   frameBorder=0 noResize width="45px" scrolling=no  height="21" vspale="0"></IFRAME>	</td>
    <td align="center" bgcolor="#FFCC00">
