...
<table width="100%" height="95%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="100%" valign="top">
      ...
      <tr>
        <td height="23" bgcolor="E7EBDE" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100" height="23" nowrap background="../../newimages/shale_fill_1.gif"><img src="../../newimages/shale_arrowhead.gif" width="28" height="23" align="absmiddle">列表</td>
      ...
      <tr>
        <td bgcolor="E7EBDE" valign="top" padding=5 style="padding: 10px;"><%
            ...
            <form name="form2" method="get" action="list.asp">
              <tr>
                <td height="30" valign="top">
                	省份<input name="area" type="text" id="area" size="10">
                	银行名称<input name="shop_name" type="text" id="shop_name" size="10">
                	属性<input name="hy_type" type="text" id="hy_type" size="10">
                	联系人<input name="contact" type="text" id="contact" size="10">
                	联系电话<input name="mobile" type="text" id="mobile" size="10">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                ...
                <tr bgcolor="<%=bgcol%>"  >
                  ...
                  <td nowrap><%=rs("hy_type")%></td>
                  <td nowrap><%=rs("contact")%></td>
                  <td nowrap><%=rs("station")%></td>
