...
strconnserver="Provider=SQLOLEDB.1;driver={SQL Server};server=(local);uid=rcu;pwd=dfds@!!#32**kangxianyue;database=rcu1"
...
if errflag=true then
	...
	rsmax.close
	set rsmax=nothing
	response.Redirect("/admin1/crmlocal/AdCrm_comp_savelocal.asp?com_id="&com_id)
