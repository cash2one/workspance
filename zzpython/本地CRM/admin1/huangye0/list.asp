...
<select name="huangye_qukan" id="huangye_qukan">
  <option value="2013">2013版</option>
  <option value="2014">2014版</option>
</select>
<script>selectOption("huangye_qukan","<%=request("huangye_qukan")%>")</script>
<select name="pcheck" id="pcheck">
...
<table width="100%" border="0" cellspacing="1" cellpadding="6" bgcolor="#000000">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><a href="add.asp?com_email=<%=rs("com_email")%>" target="_blank">修改</a></td>
