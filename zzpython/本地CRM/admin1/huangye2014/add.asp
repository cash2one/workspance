...
if request("com_email")<>"" then
	sqlc="select * from huangye_list where com_email='"&request("com_email")&"' and huangye_qukan='2014'"
...
<table width="700" border="0" align="center" cellpadding="6" cellspacing="1" bgcolor="#000000" style="font-size:12px">
  <form id="form1" name="form1" method="post" action="save.asp">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none" id="leibie1">
        <tr>
          <td>必选
