...
if pcheck="" then pcheck=0
sqlcom="select personid from huangye_list where com_email='"&com_email&"' and huangye_qukan='2014'"
...
if huangye<>1 then
	sqlcom="select * from huangye_list where com_email='"&com_email&"' and huangye_qukan='2014'"
