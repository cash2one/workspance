...
namespace Controls
{
  ...
  public class PostCalendar : Calendar, ICallbackEventHandler
  {
		...
		protected override void OnLoad(EventArgs e)
		{
            ...
            //by SpoonySonny 08.02
            base.DayNameFormat = System.Web.UI.WebControls.DayNameFormat.Short;
            base.Width = new Unit(200);
    ...
    protected override void Render(HtmlTextWriter writer)
    {
      if (!ShowPostTitles)
      {
        ...
        {
            writer.Write("<a href=\"javascript:void(location.reload(true))\">页面重载</a>");
        }
