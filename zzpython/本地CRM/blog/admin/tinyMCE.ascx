...
<script language="javascript" type="text/javascript">
  tinyMCE.init({
    ...
    language : "zh_cn_utf8",
	  ...
	  theme_advanced_buttons1_add : "fullscreen,code,separator,cut,copy,paste,separator,undo,redo,separator",
	  theme_advanced_buttons2_add : "separator,bullist,numlist,outdent,indent,separator,iespell,link,unlink,media,sub,sup,removeformat,cleanup,charmap,emotions,separator,formatselect,fontselect,fontsizeselect",
