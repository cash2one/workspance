<%@ Page Language="C#" MasterPageFile="~/admin/admin1.master" AutoEventWireup="true" CodeFile="Pages.aspx.cs" ValidateRequest="false" Inherits="admin_Pages_pages" Title="页面条目" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" Runat="Server">
  ...
  <asp:RequiredFieldValidator runat="server" ControlToValidate="txtTitle" Display="Dynamic" ErrorMessage="请输入标题" />&nbsp;&nbsp;&nbsp;
  ...
  <table id="entrySettings" width="100%">
    <tr>
      ...
      <td>
        ...
        <asp:Button runat="server" ID="btnUploadImage" Text="开始上传" ValidationGroup="imageupload" />
    ...
    <tr>
      ...
      <td>
        ...
        <asp:Button runat="server" ID="btnUploadFile" Text="开始上传" ValidationGroup="fileUpload" />
