...
<div id="tagselector" style="display: none;">
    <a href="javascript:void(ToggleTagSelector())" style="color:Black;float:right">关闭(Esc键)</a>
...
function ToggleTagSelector()
{
  ...
  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle" ErrorMessage="请输入标题" Display="Dynamic" />&nbsp;&nbsp;&nbsp;
  ...
  <asp:CheckBox runat="server" ID="cbUseRaw" Text="使用 HTML 编辑器" AutoPostBack="true" />
  
  <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDate" ValidationExpression="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9] [0-9][0-9]:[0-9][0-9]" ErrorMessage="请输入一个有效的日期 (yyyy-mm-dd hh:mm)" Display="dynamic" />
  <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDate" ErrorMessage="请输入一个日期 (yyyy-mm-dd hh:mm)" Display="Dynamic" />
  <br /><br />
  ...
  <table id="entrySettings" width="100%">
    <tr>
      ...
      <td>
        <asp:FileUpload runat="server" ID="txtUploadImage" Width="400" TabIndex="5" ValidationGroup="imageupload" />
        <asp:Button runat="server" ID="btnUploadImage" Text="开始上传" ValidationGroup="imageupload" TabIndex="6" />
    ...
    <tr>
      ...
      <td>
        ...
        <asp:Button runat="server" ID="btnUploadFile" Text="开始上传" ValidationGroup="fileUpload" TabIndex="8" />
    ...
    <tr>
      <td class="label">别名(选填)</td>
      <td>
        <asp:TextBox runat="server" ID="txtSlug" TabIndex="9" Width="400" />
        <a href="javascript:void(GetSlug());">从标题中截取</a>
      </td>
    </tr>
    <tr>
      ...
      <td><Blog:TextEditor  Toolbar="false" runat="server" id="txtDescription" TabIndex="9" Height="200px" /></td>
    ...
    <tr>
      ...
      <td>
        ...
        <asp:CustomValidator runat="Server" ID="valExist" ValidationGroup="category" ControlToValidate="txtCategory" ErrorMessage="分类已存在" Display="dynamic" />
        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCategory" ErrorMessage="必填" ValidationGroup="category" /><br />
    ...
    <tr>
      <td class="label">Tags 标签</td>
      <td>
        <asp:TextBox runat="server" ID="txtTags" Width="400" TabIndex="13" />
        <a href="javascript:void(ToggleTagSelector())">显示选择器</a>
