...
using System.Collections;//by Spoony 080313
...
public partial class admin_Pages_configuration : System.Web.UI.Page {
    ...
    private void btnTestSmtp_Click(object sender, EventArgs e) {
        try {
            ...
            mail.Subject = "这封邮件来自 " + txtName.Text;
            mail.Body = "成功";
    ...
    private void btnSave_Click(object sender, EventArgs e) {
        ...
        //by Spoony
        BlogSettings.Instance.EnableShowPagination = cbEnableShowPagination.Checked;
    ...
    private void BindSettings() {
        ...
        //by Spoony
        cbEnableShowPagination.Checked = BlogSettings.Instance.EnableShowPagination;
    ...
    {
        litClearCacheList.Text = "<br />共有 " + Cache.Count.ToString() + " 项被清除：";
        foreach (DictionaryEntry de in Cache)
        {
            litClearCacheList.Text += String.Format("<br />=> {0} 清除成功...", de.Key);
            Cache.Remove(de.Key.ToString());
        }
        litClearCacheList.Text += "<br />完毕！";
    }
}