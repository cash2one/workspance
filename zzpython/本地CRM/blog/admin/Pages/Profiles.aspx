<%@ Page Language="C#" MasterPageFile="~/admin/admin1.master" AutoEventWireup="true" ValidateRequest="False" CodeFile="Profiles.aspx.cs" Inherits="admin_profiles" Title="用户资料" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
    ...
    <div class="settings" style="padding: 0 10px">
      ...
      <asp:CompareValidator runat="server" ControlToValidate="tbBirthdate" Type="date" Operator="datatypecheck" ErrorMessage="请输入一个有效日期 (yyyy-mm-dd)" />
      <br /><br />
      
      <label for="<%=tbAboutMe.ClientID %>"><%=Resources.labels.aboutMe %></label><br />
      <Blog:TextEditor Toolbar="false" runat="server" id="tbAboutMe" Width="100%" Height="200px"  /><br /> 
    </div>
