...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" Runat="Server">
  <div id="contact">
    <div id="divForm" runat="server">
      ...
      <asp:button runat="server" id="btnSend" Text="发送" OnClientClick="return beginSendMessage();" validationgroup="contact" />    
      <asp:label runat="server" id="lblStatus" visible="false">系统故障，该功能此时尚不可用。给你造成的不便请谅解！</asp:label>
    </div>
