...
function isVaildEmail_of(s)
{
	...
	msgInfo["cmobile"]= '建议您填写，以便潜在客户及时与您取得联系！<br>中国再生资源交易网不绑定任何收费服务！';
	msgInfo["cname"]= '*国内注册企业请用中文完整填写在工商局注册的全称。<br> 如：浙江苍南县清源再生棉纺厂。<br>*无商号的个体经营者填写执照上的姓名，并标注个体经营。如：个体经营（张三）'
	msgInfo["cadd"]= '请在此填写公司地址，<br>如：杭州市西湖大道266号涌金广场聚景阁209室。';
	...
	msgerrInfo["ccontactp"]= '请输入真实姓名。';
	msgerrInfo["cemail"]= '电子邮箱格式不正确，请输入正确的电子邮箱地址!';
	msgerrInfo["cmobile"]= '建议您填写，以便潜在客户及时与您取得联系！<br>中国再生资源交易网不绑定任何收费服务！';
	msgerrInfo["cname"]= '请输入公司名称'
	msgerrInfo["cadd"]= '请在此填写公司地址，<br>如：杭州市西湖大道266号涌金广场聚景阁209室。';
	msgerrInfo["cprovince"]= '请输入省份！<br>如：浙江';
	msgerrInfo["province"]= '请选择省份！';
	msgerrInfo["city"]= '请选择城市！';
	msgerrInfo["czip"]= '请输入邮编';
	msgerrInfo["ctel"]= '请输入电话';
...
\*******************************************/
	function Dron_City(obj1,obj2,val)
	{
		...
		var cityData = [
			...
			"鞍山|本溪|朝阳|大连|沈阳|丹东|抚顺|阜新|葫芦岛|锦州|辽阳|铁岭|营口".split("|"),
			"上海".split("|"),
			...
			"白城|白山|长春|吉林|辽源|辽源|松原|通化|延边朝鲜族自治州".split("|"),
