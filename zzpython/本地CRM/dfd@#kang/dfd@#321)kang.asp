...
strconn="Provider=SQLOLEDB.1;driver={SQL Server};server=(local);uid=rcu;pwd=fdfdf^&*3423dfgdy9;database=rcu"
conn.open strconn
set connnews=server.CreateObject("ADODB.connection")
strconnnews="Provider=SQLOLEDB.1;driver={SQL Server};server=(local);uid=rcu;pwd=fdfdf^&*3423dfgdy9;database=rcu_news"
