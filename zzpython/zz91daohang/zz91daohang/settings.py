# Django settings for zz91daohang project.
...
ALLOWED_HOSTS = ["daohang.zz91.com","www.zz91.com"]
...
SECRET_KEY = '6=9^o1ecbviqkhamc4dl-ec2!=!ew5!rw7o8ao$kz=6a#_rnmv'
...
ROOT_URLCONF = 'zz91daohang.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'zz91daohang.wsgi.application'
