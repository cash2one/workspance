...
$(document).ready(function() {
	$(".gDrop").mouseover(function (){
		$(this).addClass("gDropHover");
	});	
	$(".gDrop").mouseout(function (){
		$(this).removeClass("gDropHover");
	});	
	$(".sNClass").mouseover(function (){
		$(".sNC-Con").css("display","block");
	});	
	$(".sNClass").mouseout(function (){
		$(".sNC-Con").css("display","none");
	});	
	
	$(".allClassMenu li").mouseover(function (){
		$(this).addClass("current");
	});	
	$(".allClassMenu li").mouseout(function (){
