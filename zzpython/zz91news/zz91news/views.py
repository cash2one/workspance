...
#                    return HttpResponse(altype)
                    ...
                    if content:
                        ...
                        if kind_name:
                            list_kind_tag=getmaowenbanlist()
                            for lk in list_kind_tag:
                                if lk:
                                    wenben=lk['typename']
                                    typename_hex=lk['typename_hex']
                        #            content=re.sub(wenben,'<a href="/column_list/tags-'+typename_hex+'.html" target="_blank">'+wenben+'</a>',content)
                                    replace_content='<a href="/'+kind_url+'/list/tags-'+typename_hex+'.html" target="_blank">'+wenben+'</a>'
                                    content=replace_once(wenben,content,replace_content)
                        """
                    ...
                    text_len=len(text)
                    every=1200
                    if text_len>1200 and '<tr' not in content:
                        if p_tag or br_tag:
