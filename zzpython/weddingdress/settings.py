# Django settings for weddingdress project.
import os,sys
DEBUG = True
...
FILE_CHARSET='UTF-8'
memcacheconfig="192.168.110.120:11211"
MANAGERS = ADMINS
...
SECRET_KEY = '2g_zh@agq6k6vxv)^^=@55dbt-o+13lc+9@0vpvax=b-_x2o2i'
...
ROOT_URLCONF = 'weddingdress.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'weddingdress.wsgi.application'
