...
class zznews:
    ...
    def __init__(self):
        self.dbn=dbn
    def getnewscolumn(self,reid="",typeid=""):
...
#------以下是dedecms数据
    ...
    #插入至最近浏览
    def insert_viewhistory(self,mid,aid):
        gmt_created=datetime.datetime.now()  
        sql='insert into view_history(mid,aid,gmt_created) values(%s,%s,%s)'
        self.dbn.updatetodb(sql,[mid,aid,gmt_created])
