...
def openConfirm1(request):
    ...
    service_type1=['再生通','品牌通','短信报价','简版再生通','展会产品','广告','线下纸媒','百度优化','国际站','移动生意管家','再生通发起人','终身服务','商铺服务','诚信会员','定金','微站','来电宝(1或2.8)元','来电宝五元','来电宝免月租','其他','首页直达广告','企业秀']
    service_type2=['再生通','品牌通','展会产品','广告','黄页','展会广告','百度优化','简版再生通','移动生意管家','再生通发起人','终身服务','商铺服务','诚信会员','定金','微站','来电宝(1或2.8)元','来电宝五元','来电宝免月租','其他','首页直达广告','企业秀']
    service_type3=['再生通续费','再生通','品牌通续费','展会产品','百度优化','广告续费','简版续费','移动生意管家','再生通发起人','终身服务','商铺服务','诚信会员','定金','微站','来电宝(1或2.8)元','来电宝五元','来电宝免月租','其他','首页直达广告','企业秀']
...
def serverhistory(request):
    ...
    for a in complist:
        ...
        lave=None
        isldb=None
        if crm_service_code in ['1007','1008','1009','1010']:
...
def ppcindex(request):
    ...
    if ppclist:
        for a in ppclist:
            ...
            servicelist=getservicetime(a[0],'1007,1008')
